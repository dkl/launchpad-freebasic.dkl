	...
	#fbc-1.01.0/src/compiler/fb-main.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size HMODLEVELBEGIN, .-HMODLEVELBEGIN
	#fbc-1.01.0/src/compiler/fb-main.bas' compilation took 0.02778689994011074 secs
