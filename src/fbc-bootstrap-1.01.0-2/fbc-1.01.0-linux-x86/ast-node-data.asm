	...
	#fbc-1.01.0/src/compiler/ast-node-data.bas' compilation started at 15:27:33 (FreeBASIC 1.01.0)
...
.int 0
.int 0
	#fbc-1.01.0/src/compiler/ast-node-data.bas' compilation took 0.027650929056108 secs
