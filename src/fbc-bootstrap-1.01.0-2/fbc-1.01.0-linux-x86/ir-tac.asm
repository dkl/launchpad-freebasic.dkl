	...
	#fbc-1.01.0/src/compiler/ir-tac.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size _GLOBAL__D, .-_GLOBAL__D
	#fbc-1.01.0/src/compiler/ir-tac.bas' compilation took 0.04336203285492957 secs
