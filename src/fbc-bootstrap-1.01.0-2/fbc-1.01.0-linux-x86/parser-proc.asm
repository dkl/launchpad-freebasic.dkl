	...
	#fbc-1.01.0/src/compiler/parser-proc.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HSETUDTPROPERTYFLAGS, .-HSETUDTPROPERTYFLAGS
	#fbc-1.01.0/src/compiler/parser-proc.bas' compilation took 0.04704896034672856 secs
