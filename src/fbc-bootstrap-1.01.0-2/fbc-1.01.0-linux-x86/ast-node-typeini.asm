	...
	#fbc-1.01.0/src/compiler/ast-node-typeini.bas' compilation started at 15:27:33 (FreeBASIC 1.01.0)
...
ret
.size HWALK, .-HWALK
	#fbc-1.01.0/src/compiler/ast-node-typeini.bas' compilation took 0.04373107582796365 secs
