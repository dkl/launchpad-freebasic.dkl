	...
	#fbc-1.01.0/src/compiler/parser-expr-constant.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-expr-constant.bas' compilation took 0.02590111561585218 secs
