	...
	#fbc-1.01.0/src/compiler/parser-expr-unary.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HVARPTRBODY, .-HVARPTRBODY
	#fbc-1.01.0/src/compiler/parser-expr-unary.bas' compilation took 0.03017493546940386 secs
