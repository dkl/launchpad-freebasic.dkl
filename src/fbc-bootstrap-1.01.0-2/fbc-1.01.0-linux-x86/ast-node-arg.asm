	...
	#fbc-1.01.0/src/compiler/ast-node-arg.bas' compilation started at 15:27:32 (FreeBASIC 1.01.0)
...
.size HCREATEOPTARG, .-HCREATEOPTARG
	#fbc-1.01.0/src/compiler/ast-node-arg.bas' compilation took 0.03720489551778883 secs
