	...
	#fbc-1.01.0/src/compiler/rtl-string.bas' compilation started at 15:27:37 (FreeBASIC 1.01.0)
...
.size HEVALASCCASE, .-HEVALASCCASE
	#fbc-1.01.0/src/compiler/rtl-string.bas' compilation took 0.05417592951562256 secs
