	...
	#fbc-1.01.0/src/compiler/parser-proccall-args.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HOVLPROCARGLIST, .-HOVLPROCARGLIST
	#fbc-1.01.0/src/compiler/parser-proccall-args.bas' compilation took 0.02945590147282928 secs
