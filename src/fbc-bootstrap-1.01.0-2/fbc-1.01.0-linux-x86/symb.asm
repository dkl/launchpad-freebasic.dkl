	...
	#fbc-1.01.0/src/compiler/symb.bas' compilation started at 15:27:37 (FreeBASIC 1.01.0)
...
.size HFOREACHGLOBAL, .-HFOREACHGLOBAL
	#fbc-1.01.0/src/compiler/symb.bas' compilation took 0.04310300876386464 secs
