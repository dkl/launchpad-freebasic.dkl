	...
	#fbc-1.01.0/src/compiler/list.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size FATALOUTOFMEMORY, .-FATALOUTOFMEMORY
	#fbc-1.01.0/src/compiler/list.bas' compilation took 0.002984061953611672 secs

.section .rodata
.balign 4
Lt_0008:	.ascii	"fbc-1.01.0/src/compiler/list.bas\0"
