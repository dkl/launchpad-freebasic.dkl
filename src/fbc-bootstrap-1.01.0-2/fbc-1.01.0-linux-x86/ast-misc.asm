	...
	#fbc-1.01.0/src/compiler/ast-misc.bas' compilation started at 15:27:32 (FreeBASIC 1.01.0)
...
.size HSYMBISONLOCALSTACK, .-HSYMBISONLOCALSTACK
	#fbc-1.01.0/src/compiler/ast-misc.bas' compilation took 0.04411601135507226 secs
