	...
	#fbc-1.01.0/src/compiler/parser-decl-proc.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-decl-proc.bas' compilation took 0.02485998347401619 secs
