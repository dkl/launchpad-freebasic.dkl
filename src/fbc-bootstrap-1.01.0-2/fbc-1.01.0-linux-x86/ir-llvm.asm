	...
	#fbc-1.01.0/src/compiler/ir-llvm.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size _GLOBAL__D, .-_GLOBAL__D
	#fbc-1.01.0/src/compiler/ir-llvm.bas' compilation took 0.04639194451738149 secs
