	...
	#fbc-1.01.0/src/compiler/rtl-macro.bas' compilation started at 15:27:37 (FreeBASIC 1.01.0)
...
.size HADDMACROS, .-HADDMACROS
	#fbc-1.01.0/src/compiler/rtl-macro.bas' compilation took 0.02914411493111402 secs
