	...
	#fbc-1.01.0/src/compiler/pp-pragma.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size PRAGMAPOP, .-PRAGMAPOP
	#fbc-1.01.0/src/compiler/pp-pragma.bas' compilation took 0.02705005102325231 secs
