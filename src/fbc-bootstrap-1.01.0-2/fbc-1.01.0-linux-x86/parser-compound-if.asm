	...
	#fbc-1.01.0/src/compiler/parser-compound-if.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HIFSINGLELINE, .-HIFSINGLELINE
	#fbc-1.01.0/src/compiler/parser-compound-if.bas' compilation took 0.02699897659476846 secs
