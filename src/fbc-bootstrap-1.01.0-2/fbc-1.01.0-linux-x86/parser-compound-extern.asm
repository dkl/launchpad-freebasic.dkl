	...
	#fbc-1.01.0/src/compiler/parser-compound-extern.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-compound-extern.bas' compilation took 0.02537708880845457 secs
