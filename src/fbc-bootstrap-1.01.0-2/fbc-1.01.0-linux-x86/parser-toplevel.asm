	...
	#fbc-1.01.0/src/compiler/parser-toplevel.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HEMITCURRENTLINETEXT, .-HEMITCURRENTLINETEXT
	#fbc-1.01.0/src/compiler/parser-toplevel.bas' compilation took 0.0267561167711392 secs
