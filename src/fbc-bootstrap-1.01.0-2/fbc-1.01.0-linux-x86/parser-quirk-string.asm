	...
	#fbc-1.01.0/src/compiler/parser-quirk-string.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size CSTRASC, .-CSTRASC
	#fbc-1.01.0/src/compiler/parser-quirk-string.bas' compilation took 0.04018611600622535 secs
