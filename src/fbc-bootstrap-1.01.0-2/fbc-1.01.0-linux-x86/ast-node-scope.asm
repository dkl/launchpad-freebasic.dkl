	...
	#fbc-1.01.0/src/compiler/ast-node-scope.bas' compilation started at 15:27:33 (FreeBASIC 1.01.0)
...
.size HCHECKBRANCH, .-HCHECKBRANCH
	#fbc-1.01.0/src/compiler/ast-node-scope.bas' compilation took 0.03455604147166014 secs
