	...
	#fbc-1.01.0/src/compiler/parser-identifier.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HISSTRUCTALLOWED, .-HISSTRUCTALLOWED
	#fbc-1.01.0/src/compiler/parser-identifier.bas' compilation took 0.0299489067401737 secs
