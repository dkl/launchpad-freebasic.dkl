	...
	#fbc-1.01.0/src/compiler/parser-compound-namespace.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size NAMESPACEBEGIN, .-NAMESPACEBEGIN
	#fbc-1.01.0/src/compiler/parser-compound-namespace.bas' compilation took 0.02670506620779634 secs
