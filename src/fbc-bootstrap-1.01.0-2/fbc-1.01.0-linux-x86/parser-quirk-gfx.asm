	...
	#fbc-1.01.0/src/compiler/parser-quirk-gfx.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HGETMODE, .-HGETMODE
	#fbc-1.01.0/src/compiler/parser-quirk-gfx.bas' compilation took 0.04444303479976952 secs
