	...
	#fbc-1.01.0/src/compiler/parser-expr-variable.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HIMPFIELD, .-HIMPFIELD
	#fbc-1.01.0/src/compiler/parser-expr-variable.bas' compilation took 0.03665498830378056 secs
