	...
	#fbc-1.01.0/src/compiler/symb-typedef.bas' compilation started at 15:27:38 (FreeBASIC 1.01.0)
...
.size HFIXFORWARDREF, .-HFIXFORWARDREF
	#fbc-1.01.0/src/compiler/symb-typedef.bas' compilation took 0.02641005825717002 secs
