	...
	#fbc-1.01.0/src/compiler/parser-decl-struct.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HPATCHBYVALRESULTTOSELF, .-HPATCHBYVALRESULTTOSELF
	#fbc-1.01.0/src/compiler/parser-decl-struct.bas' compilation took 0.0317970949690789 secs
