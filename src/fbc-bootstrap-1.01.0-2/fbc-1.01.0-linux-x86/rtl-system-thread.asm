	...
	#fbc-1.01.0/src/compiler/rtl-system-thread.bas' compilation started at 15:27:37 (FreeBASIC 1.01.0)
...
.size HGETEXPRREF, .-HGETEXPRREF
	#fbc-1.01.0/src/compiler/rtl-system-thread.bas' compilation took 0.0297909959917888 secs
