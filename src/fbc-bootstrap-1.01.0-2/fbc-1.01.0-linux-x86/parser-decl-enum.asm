	...
	#fbc-1.01.0/src/compiler/parser-decl-enum.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HENUMCONSTDECL, .-HENUMCONSTDECL
	#fbc-1.01.0/src/compiler/parser-decl-enum.bas' compilation took 0.02699007256887853 secs
