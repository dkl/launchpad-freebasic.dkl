	...
	#fbc-1.01.0/src/compiler/parser-quirk-on.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size CGOTBSTMT, .-CGOTBSTMT
	#fbc-1.01.0/src/compiler/parser-quirk-on.bas' compilation took 0.03158810653258115 secs
