	...
	#fbc-1.01.0/src/compiler/ast-vectorize.bas' compilation started at 15:27:33 (FreeBASIC 1.01.0)
...
.size HCHECKLINK, .-HCHECKLINK
	#fbc-1.01.0/src/compiler/ast-vectorize.bas' compilation took 0.02981600537896156 secs
