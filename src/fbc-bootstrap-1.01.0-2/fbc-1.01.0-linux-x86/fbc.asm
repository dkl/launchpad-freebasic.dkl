	...
	#fbc-1.01.0/src/compiler/fbc.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size _GLOBAL__D, .-_GLOBAL__D
	#fbc-1.01.0/src/compiler/fbc.bas' compilation took 0.02895704878028482 secs
