	...
	#fbc-1.01.0/src/compiler/parser-quirk-goto-return.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HGOSUBRETURN, .-HGOSUBRETURN
	#fbc-1.01.0/src/compiler/parser-quirk-goto-return.bas' compilation took 0.03137597790919244 secs
