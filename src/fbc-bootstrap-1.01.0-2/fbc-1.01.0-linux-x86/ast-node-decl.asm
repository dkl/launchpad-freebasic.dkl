	...
	#fbc-1.01.0/src/compiler/ast-node-decl.bas' compilation started at 15:27:33 (FreeBASIC 1.01.0)
...
.size HDEFAULTINIT, .-HDEFAULTINIT
	#fbc-1.01.0/src/compiler/ast-node-decl.bas' compilation took 0.02296305017080158 secs
