	...
	#fbc-1.01.0/src/compiler/parser-compound-scope.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-compound-scope.bas' compilation took 0.02642395358998328 secs
