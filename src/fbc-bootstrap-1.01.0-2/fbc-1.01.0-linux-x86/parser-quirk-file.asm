	...
	#fbc-1.01.0/src/compiler/parser-quirk-file.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HFILERENAME, .-HFILERENAME
	#fbc-1.01.0/src/compiler/parser-quirk-file.bas' compilation took 0.04043590207584202 secs
