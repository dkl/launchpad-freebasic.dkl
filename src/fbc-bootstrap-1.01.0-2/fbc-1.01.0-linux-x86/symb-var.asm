	...
	#fbc-1.01.0/src/compiler/symb-var.bas' compilation started at 15:27:38 (FreeBASIC 1.01.0)
...
.size SYMBRECALCARRAYDIFFANDELEMENTS, .-SYMBRECALCARRAYDIFFANDELEMENTS
	#fbc-1.01.0/src/compiler/symb-var.bas' compilation took 0.03545694064814597 secs
