	...
	#fbc-1.01.0/src/compiler/rtl-error.bas' compilation started at 15:27:37 (FreeBASIC 1.01.0)
...
.size HERRORTHROW, .-HERRORTHROW
	#fbc-1.01.0/src/compiler/rtl-error.bas' compilation took 0.03428097744472325 secs
