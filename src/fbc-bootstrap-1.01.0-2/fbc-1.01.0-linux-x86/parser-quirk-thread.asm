	...
	#fbc-1.01.0/src/compiler/parser-quirk-thread.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-quirk-thread.bas' compilation took 0.03060310962609947 secs
