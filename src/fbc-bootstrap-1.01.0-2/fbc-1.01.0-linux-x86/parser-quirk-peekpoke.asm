	...
	#fbc-1.01.0/src/compiler/parser-quirk-peekpoke.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HOPTIONALTYPEANDFIRSTEXPR, .-HOPTIONALTYPEANDFIRSTEXPR
	#fbc-1.01.0/src/compiler/parser-quirk-peekpoke.bas' compilation took 0.02646388520952314 secs
