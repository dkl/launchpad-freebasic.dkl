	...
	#fbc-1.01.0/src/compiler/parser-decl-symbtype.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size CSYMBOLTYPEFUNCPTR, .-CSYMBOLTYPEFUNCPTR
	#fbc-1.01.0/src/compiler/parser-decl-symbtype.bas' compilation took 0.03549103287514299 secs
