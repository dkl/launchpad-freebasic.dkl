	...
	#fbc-1.01.0/src/compiler/ast-node-branch.bas' compilation started at 15:27:33 (FreeBASIC 1.01.0)
...
.size ASTNEWJMPTB, .-ASTNEWJMPTB
	#fbc-1.01.0/src/compiler/ast-node-branch.bas' compilation took 0.03424897079821676 secs
