	...
	#fbc-1.01.0/src/compiler/parser-quirk-array.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HSCOPEDSWAP, .-HSCOPEDSWAP
	#fbc-1.01.0/src/compiler/parser-quirk-array.bas' compilation took 0.03234295325819403 secs
