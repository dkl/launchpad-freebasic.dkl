	...
	#fbc-1.01.0/src/compiler/parser-compound-while.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-compound-while.bas' compilation took 0.02512302529066801 secs
