	...
	#fbc-1.01.0/src/compiler/hash.bas' compilation started at 15:27:34 (FreeBASIC 1.01.0)
...
.size HASHDELITEM, .-HASHDELITEM
	#fbc-1.01.0/src/compiler/hash.bas' compilation took 0.004001118475571275 secs
