	...
	#fbc-1.01.0/src/compiler/ast-helper.bas' compilation started at 15:27:32 (FreeBASIC 1.01.0)
...
.size HCONSTBOUND, .-HCONSTBOUND
	#fbc-1.01.0/src/compiler/ast-helper.bas' compilation took 0.04932797746732831 secs
