	...
	#fbc-1.01.0/src/compiler/symb-namespace.bas' compilation started at 15:27:38 (FreeBASIC 1.01.0)
...
.size HISONIMPORTLIST, .-HISONIMPORTLIST
	#fbc-1.01.0/src/compiler/symb-namespace.bas' compilation took 0.02736708289012313 secs
