	...
	#fbc-1.01.0/src/compiler/symb-mangling.bas' compilation started at 15:27:37 (FreeBASIC 1.01.0)
...
.size HMANGLEPROC, .-HMANGLEPROC
	#fbc-1.01.0/src/compiler/symb-mangling.bas' compilation took 0.03104701708070934 secs
