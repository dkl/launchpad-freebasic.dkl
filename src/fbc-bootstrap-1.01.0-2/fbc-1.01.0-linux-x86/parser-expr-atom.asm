	...
	#fbc-1.01.0/src/compiler/parser-expr-atom.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HCHECKID, .-HCHECKID
	#fbc-1.01.0/src/compiler/parser-expr-atom.bas' compilation took 0.02856694418005645 secs
