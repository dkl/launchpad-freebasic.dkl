	...
	#fbc-1.01.0/src/compiler/parser-decl-option.bas' compilation started at 15:27:35 (FreeBASIC 1.01.0)
...
.size HUNDEFSYMBOL, .-HUNDEFSYMBOL
	#fbc-1.01.0/src/compiler/parser-decl-option.bas' compilation took 0.02622989495284855 secs
