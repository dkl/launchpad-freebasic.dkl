	...
	#fbc-1.01.0/src/compiler/pp-define.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size HMATCHPARAMELLIPSIS, .-HMATCHPARAMELLIPSIS
	#fbc-1.01.0/src/compiler/pp-define.bas' compilation took 0.03292704350315034 secs
