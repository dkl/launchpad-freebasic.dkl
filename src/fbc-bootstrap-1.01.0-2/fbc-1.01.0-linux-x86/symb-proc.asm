	...
	#fbc-1.01.0/src/compiler/symb-proc.bas' compilation started at 15:27:38 (FreeBASIC 1.01.0)
...
.size HRESULTTOSTR, .-HRESULTTOSTR
	#fbc-1.01.0/src/compiler/symb-proc.bas' compilation took 0.05128094356041402 secs
