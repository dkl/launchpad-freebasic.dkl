	...
	#fbc-1.01.0/src/compiler/parser-quirk-vafirst.bas' compilation started at 15:27:36 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-quirk-vafirst.bas' compilation took 0.02516107587143779 secs
