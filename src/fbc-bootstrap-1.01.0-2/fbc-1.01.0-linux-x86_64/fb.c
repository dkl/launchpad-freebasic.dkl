// Compilation of fbc-1.01.0/src/compiler/fb.bas started at 15:27:40 on 02-28-2015
...
void FBINIT( int64 ISMAIN$1, int64 RESTARTS$1 )
{
	...
	*(int64*)((uint8*)&ENV$ + 1272ll) = 0ll;
	...
	void* vr$5 = fb_ErrorThrowAt( 306, (uint8*)"fbc-1.01.0/src/compiler/fb.bas", (void*)0ull, (void*)0ull );
	goto *vr$5;
	label$22:;
...
void FBCOMPILE( uint8* INFNAME$1, uint8* OUTFNAME$1, FBSTRING* PPONLYFILE$1, int64 ISMAIN$1 )
{
	...
	*($13FBFILE_FORMAT*)((uint8*)&ENV$ + 768ll) = vr$13;
	...
	if( *(int64*)((uint8*)&ENV$ + 1072ll) <= 0ll ) goto label$274;
	{
		...
		void* vr$39 = fb_ErrorThrowAt( 1046, (uint8*)"fbc-1.01.0/src/compiler/fb.bas", (void*)0ull, (void*)0ull );
		goto *vr$39;
		label$275:;
	}
	label$274:;
	...
	void* vr$44 = fb_ErrorThrowAt( 1049, (uint8*)"fbc-1.01.0/src/compiler/fb.bas", (void*)0ull, (void*)0ull );
	goto *vr$44;
	label$276:;
...
void FBINCLUDEFILE( uint8* FILENAME$1, int64 ISONCE$1 )
{
	...
	*($13FBFILE_FORMAT*)((uint8*)&ENV$ + 768ll) = vr$101;
	...
	void* vr$106 = fb_ErrorThrowAt( 1339, (uint8*)"fbc-1.01.0/src/compiler/fb.bas", (void*)0ull, (void*)0ull );
	goto *vr$106;
	label$345:;
	*(int64*)((uint8*)&ENV$ + 1128ll) = *(int64*)((uint8*)&ENV$ + 1128ll) + -1ll;
...
// Total compilation time: 0.04665406467393041 seconds.
