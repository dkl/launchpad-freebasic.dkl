// Compilation of FreeBASIC-1.01.0-source/src/compiler/pool.bas started at 16:30:14 on 02-28-2015
...
void POOLINIT( struct $5TPOOL* POOL$1, int64 ITEMS$1, int64 MINLEN$1, int64 MAXLEN$1 )
{
	...
	*(int64*)((uint8*)POOL$1 + 8ll) = MINLEN$1;
	void* vr$12 = XALLOCATE( (int32)(*(int64*)POOL$1 << 6ll) );
	*(struct $5TLIST**)((uint8*)POOL$1 + 16ll) = (struct $5TLIST*)vr$12;
	...
	LEN_$1 = MINLEN$1;
	{
		...
		label$7:;
		{
			LISTINIT( (struct $5TLIST*)((uint8*)*(struct $5TLIST**)((uint8*)POOL$1 + 16ll) + (I$2 << 6ll)), ITEMS$1, LEN_$1, 2ll );
...
void POOLEND( struct $5TPOOL* POOL$1 )
{
	label$8:;
	{
		...
		label$13:;
		{
			LISTEND( (struct $5TLIST*)((uint8*)*(struct $5TLIST**)((uint8*)POOL$1 + 16ll) + (I$2 << 6ll)) );
		}
		label$11:;
		I$2 = I$2 + 1ll;
		label$10:;
...
void* POOLNEWITEM( struct $5TPOOL* POOL$1, int64 LEN_$1 )
{
	...
	{
		void* vr$9 = XALLOCATE( (int32)(LEN_$1 + 8ll) );
		ITEM$1 = (struct $9TPOOLITEM*)vr$9;
	}
	goto label$18;
	label$19:;
	{
		void* vr$13 = LISTNEWNODE( (struct $5TLIST*)((uint8*)*(struct $5TLIST**)((uint8*)POOL$1 + 16ll) + (IDX$1 << 6ll)) );
		ITEM$1 = (struct $9TPOOLITEM*)vr$13;
	}
	label$18:;
	*(int64*)ITEM$1 = IDX$1;
...
void POOLDELITEM( struct $5TPOOL* POOL$1, void* NODE$1 )
{
	...
	label$25:;
	{
		LISTDELNODE( (struct $5TLIST*)((uint8*)*(struct $5TLIST**)((uint8*)POOL$1 + 16ll) + (*(int64*)ITEM$1 << 6ll)), (void*)ITEM$1 );
	}
	label$24:;
	label$21:;
}

// Total compilation time: 0.001734076300635934 seconds.
