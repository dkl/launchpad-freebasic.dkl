// Compilation of FreeBASIC-1.01.0-source/src/compiler/parser-expr-function.bas started at 16:30:12 on 02-28-2015
...
struct $7ASTNODE* CFUNCTIONCALL( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* PTREXPR$1, struct $7ASTNODE* THISEXPR$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
	...
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 32768ll) == 0ll ) goto label$15;
	{
		OPTIONS$1 = OPTIONS$1 | 128ll;
		int64 vr$13 = LEXGETTOKEN( 0ll );
		if( vr$13 != 40ll ) goto label$17;
		{
			if( (int64)-(((int64)*(int16*)((uint8*)*(struct $8FBSYMBOL**)*(struct $10FBSYMBOLTB**)((uint8*)SYM$1 + 272ll) + 200ll) & 512ll) != 0ll) != 0ll ) goto label$19;
			{
			...
			label$18:;
			LEXSKIPTOKEN( 0ll );
			struct $7ASTNODE* vr$23 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 );
			FUNCEXPR$1 = vr$23;
			if( FUNCEXPR$1 != (struct $7ASTNODE*)0ull ) goto label$21;
			{
				goto label$11;
			}
			label$21:;
		...
		label$17:;
		{
			if( (int64)-(((int64)*(int16*)((uint8*)*(struct $8FBSYMBOL**)*(struct $10FBSYMBOLTB**)((uint8*)SYM$1 + 272ll) + 200ll) & 128ll) != 0ll) != 0ll ) goto label$25;
			{
				ERRREPORT( 193ll, 0ll, (uint8*)0ull );
			}
			label$25:;
			label$24:;
			struct $7ASTNODE* vr$36 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 | 32ll );
			FUNCEXPR$1 = vr$36;
			if( FUNCEXPR$1 != (struct $7ASTNODE*)0ull ) goto label$27;
			{
				goto label$11;
			}
			label$27:;
	...
	label$15:;
	{
		...
		if( vr$38 != 40ll ) goto label$29;
		{
			LEXSKIPTOKEN( 0ll );
			struct $7ASTNODE* vr$41 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 );
			FUNCEXPR$1 = vr$41;
			if( FUNCEXPR$1 != (struct $7ASTNODE*)0ull ) goto label$31;
			{
				goto label$11;
			}
			label$31:;
		...
		label$29:;
		{
			struct $7ASTNODE* vr$47 = CPROCARGLIST( BASE_PARENT$1, SYM$1, PTREXPR$1, &ARG_LIST$1, OPTIONS$1 | 32ll );
			FUNCEXPR$1 = vr$47;
			if( FUNCEXPR$1 != (struct $7ASTNODE*)0ull ) goto label$35;
			{
				goto label$11;
			}
			label$35:;
	...
	label$14:;
	if( (*(int64*)((uint8*)FUNCEXPR$1 + 8ll) & 511ll) != 0ll ) goto label$37;
	{
	...
	label$37:;
	label$36:;
	struct $7ASTNODE* vr$53 = ASTBUILDBYREFRESULTDEREF( FUNCEXPR$1 );
	FUNCEXPR$1 = vr$53;
	struct $7ASTNODE* vr$54 = CSTRIDXORMEMBERDEREF( FUNCEXPR$1 );
	fb$result$1 = vr$54;
	label$11:;
	return fb$result$1;
}
...
struct $7ASTNODE* CFUNCTIONEX( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* SYM$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	label$38:;
	LEXSKIPTOKEN( 0ll );
	struct $7ASTNODE* vr$1 = CFUNCTIONCALL( BASE_PARENT$1, SYM$1, (struct $7ASTNODE*)0ull, (struct $7ASTNODE*)0ull, OPTIONS$1 );
	fb$result$1 = vr$1;
	label$39:;
	return fb$result$1;
}
...
struct $7ASTNODE* CMETHODCALL( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* THISEXPR$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	LEXSKIPTOKEN( 0ll );
	if( (*(int64*)((uint8*)&PARSER$ + 288ll) & 4ll) == 0ll ) goto label$43;
	{
		struct $7ASTNODE* vr$3 = CFUNCTIONCALL( (struct $8FBSYMBOL*)0ull, SYM$1, (struct $7ASTNODE*)0ull, THISEXPR$1, OPTIONS$1 );
		EXPR$1 = vr$3;
	}
	goto label$42;
	label$43:;
	{
		struct $7ASTNODE* vr$4 = CPROCCALL( (struct $8FBSYMBOL*)0ull, SYM$1, (struct $7ASTNODE*)0ull, THISEXPR$1, 0ll, OPTIONS$1 );
		EXPR$1 = vr$4;
	}
	label$42:;
	fb$result$1 = EXPR$1;
...
struct $7ASTNODE* CCTORCALL( struct $8FBSYMBOL* SYM$1 )
{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 8ll) = (struct $11FB_CALL_ARG*)0ull;
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
	struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( *(int64*)((uint8*)SYM$1 + 48ll) & 511ll, SYM$1 );
	TMP$1 = vr$7;
	ASTDTORLISTADD( TMP$1 );
	int64 vr$8 = LEXGETTOKEN( 0ll );
	if( vr$8 != 40ll ) goto label$47;
	{
		LEXSKIPTOKEN( 0ll );
		ISPRNT$1 = -1ll;
	}
	...
	struct $11FB_CALL_ARG* vr$12 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 216ll), &ARG_LIST$1, 0ll );
	ARG$1 = vr$12;
	struct $7ASTNODE* vr$13 = ASTNEWVAR( TMP$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	*(struct $7ASTNODE**)ARG$1 = vr$13;
	*($12FB_PARAMMODE*)((uint8*)ARG$1 + 8ll) = -1ll;
	if( ISPRNT$1 != 0ll ) goto label$48;
	TMP$85$1 = 32ll;
	goto label$56;
	label$48:;
	TMP$85$1 = 0ll;
	label$56:;
	struct $8FBSYMBOL* vr$19 = SYMBGETCOMPCTORHEAD( SYM$1 );
	struct $7ASTNODE* vr$20 = CPROCARGLIST( (struct $8FBSYMBOL*)0ull, vr$19, (struct $7ASTNODE*)0ull, &ARG_LIST$1, TMP$85$1 | 80ll );
	PROCEXPR$1 = vr$20;
	if( ISPRNT$1 == 0ll ) goto label$50;
	{
		int64 vr$22 = LEXGETTOKEN( 0ll );
		if( vr$22 == 41ll ) goto label$52;
		{
			ERRREPORT( 7ll, 0ll, (uint8*)0ull );
			HSKIPUNTIL( 41ll, -1ll, 0ll, 0ll );
		}
	...
	label$50:;
	label$49:;
	if( PROCEXPR$1 != (struct $7ASTNODE*)0ull ) goto label$54;
	{
		fb$result$1 = (struct $7ASTNODE*)0ull;
	}
	goto label$53;
	label$54:;
	if( (int64)-(*(int64*)PROCEXPR$1 == 9ll) != 0ll ) goto label$55;
	{
	...
	label$55:;
	{
		...
		struct $7ASTNODE* vr$29 = ASTNEWCALLCTOR( PROCEXPR$1, vr$28 );
		fb$result$1 = vr$29;
	}
	label$53:;
	label$45:;
...
__attribute__(( constructor )) static void fb_ctor__parserzexprzfunction( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.03315790428314358 seconds.
