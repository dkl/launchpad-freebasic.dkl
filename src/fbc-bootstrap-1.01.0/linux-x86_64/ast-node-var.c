// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-var.bas started at 16:30:09 on 02-28-2015
...
struct $7ASTNODE* ASTNEWVAR( struct $8FBSYMBOL* SYM$1, int64 OFS$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$76$3;
			TMP$76$3 = *($12FB_SYMBCLASS*)SYM$1;
			if( TMP$76$3 != 7ll ) goto label$15;
			label$16:;
			{
				DTYPE$1 = 0ll;
			...
			goto label$14;
			label$15:;
			if( TMP$76$3 != 3ll ) goto label$17;
			label$18:;
			{
				DTYPE$1 = 20ll;
				if( (*(int64*)((uint8*)SYM$1 + 16ll) & 16384ll) == 0ll ) goto label$20;
				{
					SUBTYPE$1 = SYM$1;
				}
				goto label$19;
				label$20:;
				{
					struct $8FBSYMBOL* vr$8 = SYMBADDPROCPTRFROMFUNCTION( SYM$1 );
					SUBTYPE$1 = vr$8;
				}
				label$19:;
			}
	...
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$11 = ASTNEWNODE( 17ll, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$11;
	if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$23;
	{
		if( ((int64)-(*(int64*)SYM$1 == 1ll) & (int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 4194304ll) != 0ll)) == 0ll ) goto label$25;
		{
...
struct $6IRVREG* ASTLOADVAR( struct $7ASTNODE* N$1 )
{
	...
	if( S$1 == (struct $8FBSYMBOL*)0ull ) goto label$29;
	{
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 16ll) = *(int64*)((uint8*)S$1 + 16ll) | 2ll;
		OFS$1 = OFS$1 + *(int64*)((uint8*)S$1 + 80ll);
	}
	label$29:;
	label$28:;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$31;
	{
		struct $6IRVREG* vr$13 = (*(tmp$67*)((uint8*)&IR$ + 496ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), S$1, OFS$1 );
		VR$1 = vr$13;
...
__attribute__(( constructor )) static void fb_ctor__astznodezvar( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.02512089547235519 seconds.
