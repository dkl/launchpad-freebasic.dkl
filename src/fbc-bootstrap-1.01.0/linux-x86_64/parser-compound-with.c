// Compilation of FreeBASIC-1.01.0-source/src/compiler/parser-compound-with.bas started at 16:30:12 on 02-28-2015
...
void CWITHSTMTBEGIN( void )
{
	...
	if( EXPR$1 != (struct $7ASTNODE*)0ull ) goto label$21;
	{
		...
		struct $8FBSYMBOL* vr$4 = SYMBADDTEMPVAR( 7ll, (struct $8FBSYMBOL*)0ull );
	...
	label$21:;
	{
		if( (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) == 18ll ) goto label$23;
		{
		...
		label$23:;
		{
			...
			{
				struct $7ASTNODE* vr$13 = ASTBUILDCALLRESULTUDT( EXPR$1 );
				EXPR$1 = vr$13;
			}
			label$25:;
			label$24:;
	...
	label$20:;
	struct $7ASTNODE* T$1;
	struct $7ASTNODE* vr$15 = HEXTENDTEMPLIFETIME( *(struct $8FBSYMBOL**)((uint8*)SCOPENODE$1 + 24ll) );
	T$1 = vr$15;
	struct $7ASTNODE* EFFECTIVEEXPR$1;
	struct $7ASTNODE* vr$16 = ASTGETEFFECTIVENODE( EXPR$1 );
	EFFECTIVEEXPR$1 = vr$16;
	if( *(int64*)EFFECTIVEEXPR$1 != 17ll ) goto label$27;
	{
		SYM$1 = *(struct $8FBSYMBOL**)((uint8*)EFFECTIVEEXPR$1 + 24ll);
		IS_PTR$1 = 0ll;
		struct $7ASTNODE* vr$20 = ASTREBUILDWITHOUTEFFECTIVEPART( EXPR$1 );
		struct $7ASTNODE* vr$21 = ASTNEWLINK( T$1, vr$20, 0ll );
		T$1 = vr$21;
	}
	goto label$26;
	label$27:;
	{
		struct $7ASTNODE* vr$22 = ASTNEWADDROF( EXPR$1 );
		EXPR$1 = vr$22;
		OPTIONS$1 = 0ll;
		if( (int64)-((*(int64*)((uint8*)&ENV$ + 1152ll) & 2ll) != 0ll) != 0ll ) goto label$29;
		{
			OPTIONS$1 = OPTIONS$1 | 2ll;
		}
		label$29:;
		label$28:;
		struct $8FBSYMBOL* vr$29 = SYMBADDIMPLICITVAR( *(int64*)((uint8*)EXPR$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 16ll), OPTIONS$1 );
		SYM$1 = vr$29;
		if( (OPTIONS$1 & 2ll) == 0ll ) goto label$31;
		{
			struct $7ASTNODE* vr$32 = ASTNEWDECL( SYM$1, -1ll );
			ASTADDUNSCOPED( vr$32 );
			struct $7ASTNODE* vr$33 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			struct $7ASTNODE* vr$34 = ASTNEWASSIGN( vr$33, EXPR$1, 0ll );
		...
		label$31:;
		{
			struct $7ASTNODE* vr$36 = ASTNEWDECL( SYM$1, 0ll );
			struct $7ASTNODE* vr$37 = ASTNEWLINK( T$1, vr$36, 0ll );
			T$1 = vr$37;
			struct $7ASTNODE* vr$38 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			struct $7ASTNODE* vr$39 = ASTNEWASSIGN( vr$38, EXPR$1, 64ll );
			struct $7ASTNODE* vr$40 = ASTNEWLINK( T$1, vr$39, 0ll );
			T$1 = vr$40;
		}
		label$30:;
		IS_PTR$1 = -1ll;
	...
	label$26:;
	ASTADD( T$1 );
	struct $13FB_CMPSTMTSTK* vr$41 = CCOMPSTMTPUSH( 280ll, 1ll );
	STK$1 = vr$41;
...
__attribute__(( constructor )) static void fb_ctor__parserzcompoundzwith( void )
{
	label$0:;
	label$1:;
}
...
static struct $7ASTNODE* HEXTENDTEMPLIFETIME( struct $8FBSYMBOL* SCP$1 )
{
	...
	if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$13;
	{
		if( *(int64*)SYM$1 != 1ll ) goto label$15;
		{
			...
			*($13FB_SYMBATTRIB*)((uint8*)SYM$1 + 8ll) = *(int64*)((uint8*)SYM$1 + 8ll) & -4194305ll;
			struct $7ASTNODE* vr$8 = ASTNEWDECL( SYM$1, 0ll );
...
// Total compilation time: 0.03437210863921791 seconds.
