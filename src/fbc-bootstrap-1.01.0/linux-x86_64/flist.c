// Compilation of FreeBASIC-1.01.0-source/src/compiler/flist.bas started at 16:30:10 on 02-28-2015
...
void* FLISTNEWITEM( struct $6TFLIST* FLIST$1 )
{
	...
	if( *(int64*)((uint8*)FLIST$1 + 8ll) > 0ll ) goto label$9;
	{
		*(struct $7TLISTTB**)((uint8*)FLIST$1 + 104ll) = *(struct $7TLISTTB**)*(struct $7TLISTTB**)((uint8*)FLIST$1 + 104ll);
		...
		{
			*(int64*)((uint8*)FLIST$1 + 8ll) = (int64)(*(uint64*)FLIST$1 >> 1ull);
...
// Total compilation time: 0.002674008486792445 seconds.
