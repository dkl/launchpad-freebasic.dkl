// Compilation of FreeBASIC-1.01.0-source/src/compiler/fbc.bas started at 16:30:10 on 02-28-2015
...
static FBSTRING* FBCBUILDPATHTOLIBFILE( uint8* FILE$1 )
{
	...
	void* vr$50 = fb_ErrorThrowAt( 306, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$50;
	label$85:;
...
static int64 CLEARDEFLIST( FBSTRING* DEFFILE$1 )
{
	...
	if( (int64)vr$17 == 0ll ) goto label$122;
	{
		...
		void* vr$24 = fb_ErrorThrowAt( 482, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
		goto *vr$24;
		label$123:;
		fb$result$1 = 0ll;
	...
	void* vr$51 = fb_ErrorThrowAt( 497, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$51;
	label$128:;
	int32 vr$53 = fb_FileClose( (int32)FI$1 );
	if( (int64)vr$53 == 0ll ) goto label$129;
	void* vr$56 = fb_ErrorThrowAt( 498, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$56;
	label$129:;
...
static int64 HGENERATEEMPTYDEFFILE( FBSTRING* DEFFILE$1 )
{
	...
	void* vr$9 = fb_ErrorThrowAt( 512, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$9;
	label$134:;
	fb$result$1 = -1ll;
	label$131:;
...
static int64 HLINKFILES( void )
{
	...
	label$276:;
	{
		...
		label$280:;
		{
			...
			void* vr$416 = fb_ErrorThrowAt( 940, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
			goto *vr$416;
			label$283:;
			int32 vr$418 = fb_FileClose( (int32)F$3 );
			if( (int64)vr$418 == 0ll ) goto label$284;
			void* vr$421 = fb_ErrorThrowAt( 942, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
			goto *vr$421;
			label$284:;
		}
		goto label$278;
...
static void PARSEARGSFROMFILE( FBSTRING* FILENAME$1 )
{
	...
	void* vr$52 = fb_ErrorThrowAt( 2111, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$52;
	label$727:;
	fb_StrDelete( &ARG$1 );
	fb_StrDelete( &ARGS$1 );
...
static int64 HPARSEXPM( FBSTRING* XPMFILE$1, FBSTRING* CODE$1 )
{
	...
	if( (int64)vr$24 == 0ll ) goto label$858;
	{
		...
		void* vr$31 = fb_ErrorThrowAt( 2620, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
		goto *vr$31;
		label$859:;
		fb_StrDelete( &LN$1 );
		goto label$854;
	...
	void* vr$77 = fb_ErrorThrowAt( 2650, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$77;
	label$866:;
...
static int64 HCOMPILEXPM( void )
{
	...
	void* vr$49 = fb_ErrorThrowAt( 2706, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$49;
	label$881:;
...
static int64 HCOMPILEFBCTINF( void )
{
	...
	*(FBSTRING**)((uint8*)&FBCTINF$1 + 24ll) = &OBJFILE$1;
	...
	void* vr$22 = fb_ErrorThrowAt( 2986, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/fbc.bas", (void*)0ull, (void*)0ull );
	goto *vr$22;
	label$979:;
...
// Total compilation time: 0.02944809454493225 seconds.
