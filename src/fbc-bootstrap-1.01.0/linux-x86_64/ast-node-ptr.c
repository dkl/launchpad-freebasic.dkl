// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-ptr.bas started at 16:30:09 on 02-28-2015
...
struct $7ASTNODE* ASTNEWDEREF( struct $7ASTNODE* L$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 OFS$1 )
{
	...
	if( L$1 == (struct $7ASTNODE*)0ull ) goto label$13;
	{
		...
		{
			DTYPE$1 = ((*(int64*)((uint8*)L$1 + 8ll) & 31ll) | ((*(int64*)((uint8*)L$1 + 8ll) & 480ll) + -32ll)) | (((*(int64*)((uint8*)L$1 + 8ll) & 261632ll) >> 1ll) & 261632ll);
		...
		if( OFS$1 != 0ll ) goto label$17;
		{
			...
			int64 DELCHILD$3;
			{
				$13AST_NODECLASS TMP$76$4;
				TMP$76$4 = *($13AST_NODECLASS*)T$3;
				if( TMP$76$4 != 6ll ) goto label$19;
				label$20:;
				{
					DELCHILD$3 = -1ll;
				}
				goto label$18;
				label$19:;
				if( TMP$76$4 != 23ll ) goto label$21;
				label$22:;
				{
			...
			if( DELCHILD$3 == 0ll ) goto label$25;
			{
				N$1 = *(struct $7ASTNODE**)((uint8*)T$3 + 112ll);
				ASTDELNODE( T$3 );
				if( T$3 == L$1 ) goto label$27;
				{
					ASTDELNODE( L$1 );
				}
				label$27:;
		...
		label$17:;
		label$16:;
		if( *(int64*)L$1 != 16ll ) goto label$29;
		{
			int64 vr$27 = ASTCONSTFLUSHTOINT( L$1 );
			OFS$1 = OFS$1 + vr$27;
	...
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$29 = ASTNEWNODE( 20ll, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$29;
...
struct $6IRVREG* ASTLOADDEREF( struct $7ASTNODE* N$1 )
{
	...
	if( L$1 != (struct $7ASTNODE*)0ull ) goto label$33;
	{
		if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$35;
		{
			struct $6IRVREG* vr$8 = (*(tmp$69*)((uint8*)&IR$ + 512ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(int64*)((uint8*)N$1 + 40ll), (struct $6IRVREG*)0ull );
			VR$1 = vr$8;
	...
	V1$1 = vr$11;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$37;
	{
		int64 TMP$77$2;
		int64 TMP$78$2;
		if( (*(int64*)((uint8*)V1$1 + 8ll) & 480ll) == 0ll ) goto label$38;
		TMP$77$2 = 22ll;
		goto label$42;
		label$38:;
		TMP$77$2 = *(int64*)((uint8*)V1$1 + 8ll) & 31ll;
		label$42:;
		if( (*(int64*)((uint8*)V1$1 + 8ll) & 480ll) == 0ll ) goto label$39;
		TMP$78$2 = 22ll;
		goto label$43;
		label$39:;
		TMP$78$2 = *(int64*)((uint8*)V1$1 + 8ll) & 31ll;
		label$43:;
		if( (((int64)-((int64)-(*(int64*)V1$1 == 4ll) == 0ll) | (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$77$2 * 56ll)) != 0ll)) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$78$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 472ll))) == 0ll ) goto label$41;
		{
			struct $6IRVREG* vr$47 = (*(tmp$64*)((uint8*)&IR$ + 472ll))( (((*(int64*)((uint8*)N$1 + 8ll) & 511ll) & 31ll) | (((*(int64*)((uint8*)N$1 + 8ll) & 511ll) & 480ll) + 32ll)) | (((*(int64*)((uint8*)N$1 + 8ll) & 511ll) & 261632ll) << 1ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VP$1 = vr$47;
			(*(tmp$49*)((uint8*)&IR$ + 272ll))( 76ll, V1$1, VP$1 );
		}
		goto label$40;
		label$41:;
		{
		...
		label$40:;
		struct $6IRVREG* vr$52 = (*(tmp$69*)((uint8*)&IR$ + 512ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(int64*)((uint8*)N$1 + 40ll), VP$1 );
		VR$1 = vr$52;
		*(int64*)((uint8*)VR$1 + 40ll) = *(int64*)((uint8*)N$1 + 32ll);
	}
	label$37:;
...
__attribute__(( constructor )) static void fb_ctor__astznodezptr( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.02591205609496683 seconds.
