// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-data.bas started at 16:30:09 on 02-28-2015
...
struct $7ASTNODE* ASTDATASTMTSTORE( struct $7ASTNODE* TREE$1, struct $7ASTNODE* EXPR$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)TREE$1 + 120ll) = N$1;
	...
	label$19:;
	{
		...
		{
			int64 TMP$76$3;
			TMP$76$3 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
			if( TMP$76$3 == 3ll ) goto label$22;
			label$23:;
			if( TMP$76$3 != 6ll ) goto label$21;
			label$22:;
			{
				struct $8FBSYMBOL* vr$16 = ASTGETSTRLITSYMBOL( EXPR$1 );
				LITSYM$2 = vr$16;
			}
			goto label$20;
			label$21:;
		...
		{
			if( (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) == 6ll ) goto label$28;
			{
...
void ASTDATASTMTEND( struct $7ASTNODE* TREE$1 )
{
	...
	ARRAY$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTTYPEINIBEGIN( 18ll, *(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll), -1ll, 0ll );
	INITREE$1 = vr$3;
	ASTTYPEINISCOPEBEGIN( INITREE$1, (struct $8FBSYMBOL*)0ull );
	N$1 = *(struct $7ASTNODE**)((uint8*)TREE$1 + 112ll);
	{
		I$1 = 0ll;
		int64 TMP$77$2;
		TMP$77$2 = *(int64*)((uint8*)TREE$1 + 40ll) + -1ll;
		goto label$33;
		label$36:;
		{
			...
			{
				int64 TMP$78$4;
				TMP$78$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$78$4 != 1ll ) goto label$38;
				label$39:;
				{
					struct $8FBSYMBOL* vr$11 = ASTGETSTRLITSYMBOL( EXPR$1 );
					ID$1 = *(int64*)((uint8*)vr$11 + 72ll) + -1ll;
					struct $7ASTNODE* vr$13 = ASTNEWADDROF( EXPR$1 );
					EXPR$1 = vr$13;
				}
				goto label$37;
				label$38:;
				if( TMP$78$4 != 32768ll ) goto label$40;
				label$41:;
				{
					struct $8FBSYMBOL* vr$15 = ASTGETSTRLITSYMBOL( EXPR$1 );
					ID$1 = (*(int64*)((uint8*)vr$15 + 72ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 344ll)) + 32767ll;
					struct $7ASTNODE* vr$18 = ASTNEWADDROF( EXPR$1 );
					EXPR$1 = vr$18;
				}
				goto label$37;
				label$40:;
				if( TMP$78$4 != 2ll ) goto label$42;
				label$43:;
				{
					FBSTRING* vr$20 = ASTCONSTFLUSHTOSTR( EXPR$1 );
					FBSTRING* vr$22 = fb_StrAssign( (void*)&LITTEXT$1, -1ll, (void*)vr$20, -1ll, 0 );
					int64 vr$24 = fb_StrLen( (void*)&LITTEXT$1, -1ll );
					ID$1 = vr$24;
					struct $7ASTNODE* vr$25 = ASTNEWCONSTSTR( *(uint8**)&LITTEXT$1 );
					struct $7ASTNODE* vr$26 = ASTNEWADDROF( vr$25 );
					EXPR$1 = vr$26;
				}
				goto label$37;
				label$42:;
				if( TMP$78$4 == 0ll ) goto label$45;
				label$46:;
				if( TMP$78$4 != 65535ll ) goto label$44;
				label$45:;
				{
			...
			ELM$1 = *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll) + 96ll);
			struct $7ASTNODE* vr$31 = ASTNEWCONSTI( ID$1, 4ll, (struct $8FBSYMBOL*)0ull );
			ASTTYPEINIADDASSIGN( INITREE$1, vr$31, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 296ll);
			ASTTYPEINIADDASSIGN( INITREE$1, EXPR$1, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			ASTTYPEINISCOPEEND( INITREE$1, (struct $8FBSYMBOL*)0ull );
		...
		I$1 = I$1 + 1ll;
		label$33:;
		if( I$1 <= TMP$77$2 ) goto label$36;
		label$35:;
	}
	ASTTYPEINISCOPEEND( INITREE$1, (struct $8FBSYMBOL*)0ull );
	ASTTYPEINIEND( INITREE$1, -1ll );
	*(struct $7ASTNODE**)((uint8*)ARRAY$1 + 88ll) = INITREE$1;
	if( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 240ll) == (struct $8FBSYMBOL*)0ull ) goto label$48;
	{
		INITREE$1 = *(struct $7ASTNODE**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&AST$ + 240ll) + 88ll);
		...
		struct $7ASTNODE* vr$46 = ASTNEWVAR( ARRAY$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
		struct $7ASTNODE* vr$47 = ASTNEWADDROF( vr$46 );
		*(struct $7ASTNODE**)((uint8*)TN$2 + 112ll) = vr$47;
	}
	label$48:;
	label$47:;
	*(struct $8FBSYMBOL**)((uint8*)ARRAY$1 + 168ll) = *(struct $8FBSYMBOL**)((uint8*)&AST$ + 240ll);
...
struct $8FBSYMBOL* ASTDATASTMTADD( struct $8FBSYMBOL* LABEL$1, int64 ELEMENTS$1 )
{
	...
	{
		LASTLABEL$1 = *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 198000ll);
		if( ((int64)-(LASTLABEL$1 == (struct $8FBSYMBOL*)0ull) | (int64)-(*(struct $8FBSYMBOL**)((uint8*)&AST$ + 256ll) == LASTLABEL$1)) == 0ll ) goto label$60;
		{
			...
			fb_StrAssign( (void*)&ID$1, -1ll, (void*)vr$6, 0ll, 0 );
		}
		goto label$59;
		label$60:;
		{
			...
			*(struct $8FBSYMBOL**)((uint8*)&AST$ + 256ll) = LASTLABEL$1;
			...
			FBSTRING* vr$10 = fb_StrConcat( &TMP$80$3, (void*)"_{fbdata}_", 11ll, *(void**)((uint8*)LASTLABEL$1 + 24ll), 0ll );
			FBSTRING* vr$11 = fb_StrAssign( (void*)&ID$1, -1ll, (void*)vr$10, -1ll, 0 );
		}
		label$59:;
	...
	label$58:;
	{
		...
		FBSTRING* vr$16 = fb_StrConcat( &TMP$81$2, (void*)"_{fbdata}_", 11ll, *(void**)((uint8*)LABEL$1 + 24ll), 0ll );
		FBSTRING* vr$17 = fb_StrAssign( (void*)&ID$1, -1ll, (void*)vr$16, -1ll, 0 );
		*(int64*)((uint8*)DTB$1 + 8ll) = 0ll;
	}
	label$57:;
	struct $8FBSYMBOL* vr$19 = SYMBLOOKUPBYNAMEANDCLASS( (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll), *(uint8**)&ID$1, 1ll, -1ll, 0ll );
	SYM$1 = vr$19;
	if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$62;
	{
		if( LABEL$1 != (struct $8FBSYMBOL*)0ull ) goto label$64;
		{
			SYMBSETARRAYDIMTB( SYM$1, 1ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$79$1 );
	...
	struct $8FBSYMBOL* vr$23 = SYMBADDVAR( *(uint8**)&ID$1, vr$22, 18ll, *(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll), 0ll, 1ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$79$1, 3ll, 9ll );
	SYM$1 = vr$23;
...
__attribute__(( constructor )) static void fb_ctor__astznodezdata( void )
{
	label$0:;
	label$1:;
}
...
static void HCREATEDATADESC( void )
{
	...
	struct $8FBSYMBOL* vr$0 = SYMBSTRUCTBEGIN( (struct $10FBSYMBOLTB*)0ull, (struct $8FBHASHTB*)0ull, (struct $8FBSYMBOL*)0ull, (uint8*)"__FB_DATADESC$", (uint8*)0ull, 0ll, 1ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll );
	*(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll) = vr$0;
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll), (uint8*)"type", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$82$1, 4ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll), (uint8*)"node", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$82$1, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBSTRUCTEND( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 232ll), 0ll );
	label$66:;
}

// Total compilation time: 0.02992296509910375 seconds.
