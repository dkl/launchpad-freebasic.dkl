// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-vectorize.bas started at 16:30:10 on 02-28-2015
...
void ASTPROCVECTORIZE( struct $7ASTNODE* P$1 )
{
	...
	label$286:;
	{
		...
		PARALLELA$1 = 0ll;
		int64 vr$2 = HCHECKLINK( TREEA$1 );
		if( vr$2 != -1ll ) goto label$292;
		{
			NODEA$1 = *(struct $7ASTNODE**)((uint8*)TREEA$1 + 120ll);
		}
		goto label$291;
		label$292:;
		int64 vr$5 = HISVECTORIZABLE( TREEA$1 );
		if( vr$5 != -1ll ) goto label$293;
		{
			NODEA$1 = TREEA$1;
			PARALLELA$1 = -1ll;
		}
		...
		label$294:;
		{
			struct $7ASTNODE* vr$8 = HGETNEXTTREE( *(struct $7ASTNODE**)((uint8*)TREEB$1 + 136ll) );
			TREEB$1 = vr$8;
			INTRATREE$1 = 0ll;
			PARALLELB$1 = 0ll;
			...
			label$298:;
			{
				int64 vr$13 = HISVECTORIZABLE( TREEB$1 );
				if( vr$13 != -1ll ) goto label$300;
				{
					PARALLELB$1 = -1ll;
					NODEB$1 = TREEB$1;
				}
			...
			{
				int64 vr$17 = HMERGENODE( NODEA$1, NODEB$1, 0ll );
				if( vr$17 == 0ll ) goto label$304;
				{
					VECTORWIDTH$ = 0ll;
			...
			if( ((int64)-(INTRATREE$1 == -1ll) & (int64)-(*(int64*)((uint8*)&ENV$ + 248ll) >= 2ll)) == 0ll ) goto label$308;
			{
				...
				VECTORWIDTH$ = 0ll;
				label$309:;
				int64 vr$34 = ASTINTRATREEVECTORIZE( NODEA$1 );
...
static int64 HNODESMATCH( struct $7ASTNODE* VN$1, struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)VN$1 != 16ll ) goto label$19;
	{
		...
		goto label$315;
		label$22:;
		TMP$76$2 = *(int64*)((uint8*)VN$1 + 8ll) & 31ll;
		label$315:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$76$2 * 56ll)) != 1ll ) goto label$24;
		{
...
static int64 HALLOWEDINVECTORIZE( struct $7ASTNODE* N$1, int64 DEREF$1 )
{
	...
	}
	{
		...
		label$55:;
		{
			DTYPE$1 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 48ll) & 31ll;
			if( ((int64)-(DTYPE$1 == 14ll) | (int64)-(DTYPE$1 == 18ll)) == 0ll ) goto label$57;
			{
				fb$result$1 = -1ll;
				goto label$30;
			}
		...
		{
			DTYPE$1 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 48ll) & 31ll;
			if( DTYPE$1 != 14ll ) goto label$61;
			{
				fb$result$1 = -1ll;
				goto label$30;
				label$61:;
			}
			if( DTYPE$1 != 15ll ) goto label$63;
			{
				MAXVECTORWIDTH$ = 2ll;
				fb$result$1 = -1ll;
				goto label$30;
		...
		if( TMP$77$2 < 1ll ) goto label$65;
		if( TMP$77$2 > 20ll ) goto label$65;
		goto *tmp$87[TMP$77$2 - 1ll];
		label$33:;
	}
	fb$result$1 = 0ll;
	goto label$30;
		...
		if( *(int64*)N$1 != 4ll ) goto label$82;
		{
			if( ((int64)-(*(int64*)((uint8*)N$1 + 40ll) == 75ll) | (int64)-(*(int64*)((uint8*)N$1 + 40ll) == 55ll)) == 0ll ) goto label$84;
			{
				if( DOMERGE$1 == 0ll ) goto label$86;
				{
					...
					goto label$316;
					label$87:;
					TMP$78$5 = *(int64*)((uint8*)N$1 + 32ll) + 1ll;
					label$316:;
					*(int64*)((uint8*)N$1 + 32ll) = TMP$78$5;
				}
				label$86:;
				label$85:;
...
static int64 HCHECKLOAD( struct $7ASTNODE* VN$1, struct $7ASTNODE* N$1, int64 DEREF$1 )
{
	...
	struct $7ASTNODE* vr$9 = HSKIPNEWNODES( VN$1, 0ll );
	VN$1 = vr$9;
	...
	label$97:;
	label$96:;
	int64 vr$16 = HALLOWEDINVECTORIZE( VN$1, DEREF$1 );
	if( vr$16 != 0ll ) goto label$99;
	{
		fb$result$1 = 0ll;
		goto label$91;
	}
	label$99:;
	label$98:;
	int64 vr$18 = HNODESMATCH( VN$1, N$1 );
	if( vr$18 != 0ll ) goto label$101;
	{
		fb$result$1 = 0ll;
		goto label$91;
	}
	label$101:;
	label$100:;
	int64 vr$22 = HCHECKLOAD( *(struct $7ASTNODE**)((uint8*)VN$1 + 112ll), *(struct $7ASTNODE**)((uint8*)N$1 + 112ll), DEREF$1 );
	if( vr$22 != 0ll ) goto label$103;
	{
		fb$result$1 = 0ll;
		goto label$91;
		label$103:;
	}
	int64 vr$26 = HCHECKLOAD( *(struct $7ASTNODE**)((uint8*)VN$1 + 120ll), *(struct $7ASTNODE**)((uint8*)N$1 + 120ll), DEREF$1 );
	if( vr$26 != 0ll ) goto label$105;
	{
		fb$result$1 = 0ll;
		goto label$91;
		label$105:;
...
static struct $7ASTNODE* HVECTORIZENODE( struct $7ASTNODE* N$1, int64 DIST$1 )
{
	...
	if( ((int64)-(*(int64*)N$1 == 4ll) | (int64)-(*(int64*)N$1 == 3ll)) == 0ll ) goto label$113;
	{
		...
		goto label$317;
		label$114:;
		TMP$79$2 = *(int64*)((uint8*)N$1 + 32ll) + 1ll;
		label$317:;
		*(int64*)((uint8*)N$1 + 32ll) = TMP$79$2;
	}
	goto label$112;
	label$113:;
	{
		...
		label$116:;
		{
			...
			goto label$318;
			label$117:;
			TMP$80$3 = *(int64*)((uint8*)N$1 + 32ll) + 1ll;
			label$318:;
			*(int64*)((uint8*)N$1 + 32ll) = TMP$80$3;
		}
		label$115:;
	}
	label$112:;
...
static int64 HCHECKDEREFVAR( struct $7ASTNODE* N$1, int64* DTYPE$1 )
{
	...
	{
		{
			$13AST_NODECLASS TMP$81$3;
			TMP$81$3 = *($13AST_NODECLASS*)N$1;
			if( TMP$81$3 != 5ll ) goto label$125;
			label$126:;
			{
				*DTYPE$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
				if( ((int64)-(*DTYPE$1 == 14ll) | (int64)-(*DTYPE$1 == 15ll)) == 0ll ) goto label$128;
				{
					RESULT$1 = -1ll;
				}
				label$128:;
			...
			goto label$124;
			label$125:;
			if( TMP$81$3 == 17ll ) goto label$130;
			label$131:;
			if( TMP$81$3 != 19ll ) goto label$129;
			label$130:;
			{
				*DTYPE$1 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 48ll) & 31ll;
				if( ((int64)-(*DTYPE$1 == 14ll) | (int64)-(*DTYPE$1 == 15ll)) == 0ll ) goto label$133;
				{
					RESULT$1 = -1ll;
				}
				label$133:;
...
static int64 HCHECKARRAYVAR( struct $7ASTNODE* N$1, int64* DTYPE$1 )
{
	...
	{
		*DTYPE$1 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 48ll) & 31ll;
		if( ((int64)-(*DTYPE$1 == 14ll) | (int64)-(*DTYPE$1 == 15ll)) == 0ll ) goto label$142;
		{
			fb$result$1 = -1ll;
		}
		label$142:;
...
static int64 HCHECKMEMOFFSET( struct $7ASTNODE* VECTORNODE$1, int64 OFFSET$1, $11FB_DATATYPE DTYPE$1 )
{
	...
	if( *(int64*)((uint8*)VECTORNODE$1 + 32ll) == 0ll ) goto label$146;
	{
		...
		goto label$319;
		label$149:;
		TMP$82$2 = DTYPE$1 & 31ll;
		label$319:;
		NEEDOFFSET$1 = VECTORWIDTH$ * *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$82$2 * 56ll)) + 8ll);
	}
	goto label$145;
	label$146:;
	{
		...
		label$320:;
		NEEDOFFSET$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$83$2 * 56ll)) + 8ll);
	}
	label$145:;
	fb$result$1 = -1ll;
	if( ((int64)-(DTYPE$1 == 14ll) | (int64)-(DTYPE$1 == 15ll)) == 0ll ) goto label$152;
	{
...
static $11FB_DATATYPE HGETASSIGNDATATYPE( struct $7ASTNODE* N$1 )
{
	...
	}
	{
		...
		if( TMP$84$2 != 5ll ) goto label$162;
		label$163:;
		{
		...
		goto label$161;
		label$162:;
		if( TMP$84$2 == 17ll ) goto label$165;
		label$166:;
		if( TMP$84$2 != 19ll ) goto label$164;
		label$165:;
		{
			fb$result$1 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 48ll) & 31ll;
			goto label$158;
		}
		goto label$161;
		label$164:;
		{
			$11FB_DATATYPE vr$12 = HGETASSIGNDATATYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll) );
			fb$result$1 = vr$12;
			goto label$158;
		}
		label$167:;
...
static int64 HMERGENODE( struct $7ASTNODE* VECTORNODE$1, struct $7ASTNODE* N$1, int64 DOMERGE$1 )
{
	...
	struct $7ASTNODE* vr$3 = HSKIPNEWNODES( VECTORNODE$1, DOMERGE$1 );
	VECTORNODE$1 = vr$3;
	if( DOMERGE$1 != 0ll ) goto label$175;
	{
		int64 vr$5 = HNODESMATCH( VECTORNODE$1, N$1 );
		if( vr$5 != 0ll ) goto label$177;
		{
			fb$result$1 = 0ll;
			goto label$169;
		}
		label$177:;
		label$176:;
		int64 vr$7 = HALLOWEDINVECTORIZE( VECTORNODE$1, 0ll );
		if( vr$7 != 0ll ) goto label$179;
		{
			fb$result$1 = 0ll;
			goto label$169;
		}
	...
	{
		$11FB_DATATYPE vr$11 = HGETASSIGNDATATYPE( VECTORNODE$1 );
		DTYPE$1 = vr$11;
		N_OFS$1 = 0ll;
		VN_OFS$1 = 0ll;
		...
		if( *(int64*)((uint8*)VECTORNODE$1 + 32ll) == 0ll ) goto label$183;
		{
			...
			label$321:;
			NEEDOFFSET$1 = VECTORWIDTH$ * *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$85$3 * 56ll)) + 8ll);
		}
		goto label$182;
		label$183:;
		{
			...
			label$322:;
			NEEDOFFSET$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$86$3 * 56ll)) + 8ll);
		}
		label$182:;
	...
	if( *(int64*)VECTORNODE$1 != 19ll ) goto label$193;
	{
		...
		{
			int64 vr$35 = HCHECKLOAD( VECTORNODE$1, N$1, 0ll );
			if( vr$35 != 0ll ) goto label$197;
			{
				fb$result$1 = 0ll;
				goto label$169;
			}
		...
		HGETVARDISTANCE( VECTORNODE$1, &VN_OFS$1, N$1, &N_OFS$1 );
		OFFSET$1 = N_OFS$1 - VN_OFS$1;
		DTYPE$1 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)VECTORNODE$1 + 24ll) + 48ll) & 31ll;
		int64 vr$43 = HCHECKMEMOFFSET( VECTORNODE$1, OFFSET$1, DTYPE$1 );
		if( vr$43 != 0ll ) goto label$199;
		{
			fb$result$1 = 0ll;
			goto label$169;
		}
	...
	if( ((int64)-(*(int64*)VECTORNODE$1 == 20ll) | (int64)-(*(int64*)VECTORNODE$1 == 18ll)) == 0ll ) goto label$205;
	{
		...
		{
			int64 vr$57 = HCHECKLOAD( VECTORNODE$1, N$1, -1ll );
			if( vr$57 != 0ll ) goto label$209;
			{
				fb$result$1 = 0ll;
				goto label$169;
			}
		...
		{
			int64 vr$63 = HCHECKDEREFVAR( *(struct $7ASTNODE**)((uint8*)VECTORNODE$1 + 112ll), &DTYPE$1 );
			if( vr$63 != 0ll ) goto label$213;
			{
				fb$result$1 = 0ll;
				goto label$169;
			}
		...
		label$211:;
		{
			int64 vr$67 = HCHECKARRAYVAR( *(struct $7ASTNODE**)((uint8*)VECTORNODE$1 + 120ll), &DTYPE$1 );
			if( vr$67 != 0ll ) goto label$215;
			{
				fb$result$1 = 0ll;
				goto label$169;
			}
		...
		HGETVARDISTANCE( VECTORNODE$1, &VN_OFS$1, N$1, &N_OFS$1 );
		OFFSET$1 = N_OFS$1 - VN_OFS$1;
		int64 vr$72 = HCHECKMEMOFFSET( VECTORNODE$1, OFFSET$1, DTYPE$1 );
		if( vr$72 != 0ll ) goto label$217;
		{
			fb$result$1 = 0ll;
			goto label$169;
		}
	...
	if( *(int64*)VECTORNODE$1 != 17ll ) goto label$223;
	{
		...
		{
			int64 vr$82 = HCHECKLOAD( VECTORNODE$1, N$1, 0ll );
			if( vr$82 != 0ll ) goto label$227;
			{
				fb$result$1 = 0ll;
				goto label$169;
			}
	...
	{
		DTYPE$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
		if( ((int64)-(DTYPE$1 == 14ll) | (int64)-(DTYPE$1 == 15ll)) == 0ll ) goto label$235;
		{
	...
	label$241:;
	label$240:;
	int64 vr$99 = HMERGENODE( *(struct $7ASTNODE**)((uint8*)VECTORNODE$1 + 112ll), *(struct $7ASTNODE**)((uint8*)N$1 + 112ll), DOMERGE$1 );
	if( vr$99 != 0ll ) goto label$243;
	{
		fb$result$1 = 0ll;
		goto label$169;
		label$243:;
	}
	int64 vr$103 = HMERGENODE( *(struct $7ASTNODE**)((uint8*)VECTORNODE$1 + 120ll), *(struct $7ASTNODE**)((uint8*)N$1 + 120ll), DOMERGE$1 );
	if( vr$103 != 0ll ) goto label$245;
	{
		fb$result$1 = 0ll;
		goto label$169;
		label$245:;
...
static int64 ASTINTRATREEVECTORIZE( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)N$1 != 3ll ) goto label$255;
	{
		if( *(int64*)((uint8*)N$1 + 40ll) != 28ll ) goto label$257;
		{
			MAXVECTORWIDTH$ = 4ll;
			VECTORWIDTH$ = 0ll;
			int64 vr$8 = HMERGENODE( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll), *(struct $7ASTNODE**)((uint8*)N$1 + 120ll), 0ll );
			if( vr$8 == 0ll ) goto label$259;
			{
				MAXVECTORWIDTH$ = 4ll;
				VECTORWIDTH$ = 0ll;
	...
	label$255:;
	label$254:;
	int64 vr$24 = ASTINTRATREEVECTORIZE( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll) );
	if( vr$24 != -1ll ) goto label$265;
	{
		CHANGED$1 = -1ll;
	}
	label$265:;
	label$264:;
	int64 vr$27 = ASTINTRATREEVECTORIZE( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll) );
	if( vr$27 != -1ll ) goto label$267;
	{
		CHANGED$1 = -1ll;
	}
	label$267:;
...
// Total compilation time: 0.02964295749552548 seconds.
