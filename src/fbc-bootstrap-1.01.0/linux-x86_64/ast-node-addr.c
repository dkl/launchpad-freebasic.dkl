// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-addr.bas started at 16:30:08 on 02-28-2015
...
int64 ASTGETOFFSETCHILDOFS( struct $7ASTNODE* L$1 )
{
	...
	label$13:;
	{
		fb$result$1 = ((*(int64*)((uint8*)L$1 + 40ll) + *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)L$1 + 120ll) + 40ll)) + *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll) + 112ll)) + *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll) + 80ll);
	}
	label$12:;
	label$11:;
	return fb$result$1;
...
struct $6IRVREG* ASTLOADOFFSET( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$11 = (*(tmp$67*)((uint8*)&IR$ + 520ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), SYM$1, *(int64*)((uint8*)N$1 + 40ll) );
		VR$1 = vr$11;
	}
	label$25:;
	label$24:;
...
struct $7ASTNODE* ASTNEWADDROF( struct $7ASTNODE* L$1 )
{
	...
	label$48:;
	struct $7ASTNODE* T$1;
	struct $7ASTNODE* vr$2 = ASTSKIPNOCONVCAST( L$1 );
	T$1 = vr$2;
	N$1 = (struct $7ASTNODE*)0ull;
	{
		$13AST_NODECLASS TMP$78$2;
		TMP$78$2 = *($13AST_NODECLASS*)T$1;
		if( TMP$78$2 != 20ll ) goto label$51;
		label$52:;
		{
			if( *(int64*)((uint8*)&ENV$ + 312ll) == 0ll ) goto label$54;
			{
			...
			label$56:;
			{
				struct $7ASTNODE* vr$12 = ASTNEWCONSTI( *(int64*)((uint8*)T$1 + 40ll), 7ll, (struct $8FBSYMBOL*)0ull );
				N$1 = vr$12;
				ASTDELNODE( T$1 );
			}
			label$55:;
		...
		goto label$50;
		label$51:;
		if( TMP$78$2 != 19ll ) goto label$59;
		label$60:;
		{
			if( *(int64*)*(struct $7ASTNODE**)((uint8*)T$1 + 112ll) != 20ll ) goto label$62;
			{
				if( *(int64*)((uint8*)&ENV$ + 312ll) == 0ll ) goto label$64;
				{
				...
				{
					struct $7ASTNODE* vr$24 = ASTNEWCONSTI( *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)T$1 + 112ll) + 40ll), 7ll, (struct $8FBSYMBOL*)0ull );
					N$1 = vr$24;
		...
		goto label$50;
		label$59:;
		if( TMP$78$2 != 17ll ) goto label$67;
		label$68:;
		{
			...
			{
				if( ((int64)-((int64)-((*(int64*)((uint8*)S$3 + 8ll) & 128ll) != 0ll) == 0ll) | (int64)-((*(int64*)((uint8*)S$3 + 8ll) & 11ll) != 0ll)) == 0ll ) goto label$72;
				{
					struct $7ASTNODE* vr$38 = ASTNEWOFFSET( T$1 );
					N$1 = vr$38;
				}
				label$72:;
				label$71:;
		...
		goto label$50;
		label$67:;
		if( TMP$78$2 != 18ll ) goto label$73;
		label$74:;
		{
			if( T$1 == L$1 ) goto label$76;
			{
				struct $7ASTNODE* vr$41 = ASTOPTIMIZETREE( T$1 );
				T$1 = vr$41;
			...
			label$76:;
			{
				struct $7ASTNODE* vr$43 = ASTOPTIMIZETREE( T$1 );
				T$1 = vr$43;
				L$1 = T$1;
			}
			label$75:;
			if( *(struct $7ASTNODE**)((uint8*)T$1 + 112ll) != (struct $7ASTNODE*)0ull ) goto label$78;
			{
				...
				if( ((int64)-((int64)-((*(int64*)((uint8*)S$4 + 8ll) & 128ll) != 0ll) == 0ll) | (int64)-((*(int64*)((uint8*)S$4 + 8ll) & 11ll) != 0ll)) == 0ll ) goto label$80;
				{
					if( (int64)-((*(int64*)((uint8*)S$4 + 8ll) & 65540ll) != 0ll) != 0ll ) goto label$82;
					{
						struct $7ASTNODE* vr$60 = ASTNEWOFFSET( T$1 );
						N$1 = vr$60;
					}
					label$82:;
					label$81:;
	...
	DTYPE$1 = ((*(int64*)((uint8*)L$1 + 8ll) & 31ll) | ((*(int64*)((uint8*)L$1 + 8ll) & 480ll) + 32ll)) | ((*(int64*)((uint8*)L$1 + 8ll) & 261632ll) << 1ll);
	...
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$84;
	{
		...
		label$86:;
		label$85:;
		struct $7ASTNODE* vr$74 = ASTNEWCONV( DTYPE$1, SUBTYPE$1, N$1, 8ll, (int64*)0ull );
		fb$result$1 = vr$74;
		goto label$47;
	}
	label$84:;
	label$83:;
	struct $7ASTNODE* vr$75 = ASTNEWNODE( 6ll, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$75;
...
struct $6IRVREG* ASTLOADADDROF( struct $7ASTNODE* N$1 )
{
	...
	label$90:;
	label$89:;
	struct $6IRVREG* vr$3 = ASTLOAD( P$1 );
	V1$1 = vr$3;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$92;
	{
		...
		goto label$97;
		label$93:;
		TMP$79$2 = *(int64*)((uint8*)V1$1 + 8ll) & 31ll;
		label$97:;
		if( (*(int64*)((uint8*)V1$1 + 8ll) & 480ll) == 0ll ) goto label$94;
		TMP$80$2 = 22ll;
		goto label$98;
		label$94:;
		TMP$80$2 = *(int64*)((uint8*)V1$1 + 8ll) & 31ll;
		label$98:;
		if( (((int64)-((int64)-(*(int64*)V1$1 == 4ll) == 0ll) | (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$79$2 * 56ll)) != 0ll)) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$80$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 472ll))) == 0ll ) goto label$96;
		{
			struct $6IRVREG* vr$28 = (*(tmp$64*)((uint8*)&IR$ + 472ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VR$1 = vr$28;
			(*(tmp$49*)((uint8*)&IR$ + 272ll))( 22ll, V1$1, VR$1 );
		}
		goto label$95;
		label$96:;
		{
...
__attribute__(( constructor )) static void fb_ctor__astznodezaddr( void )
{
	label$0:;
	label$1:;
}
...
static struct $7ASTNODE* ASTNEWOFFSET( struct $7ASTNODE* L$1 )
{
	...
	label$17:;
	label$16:;
	struct $7ASTNODE* vr$13 = ASTNEWNODE( 23ll, ((*(int64*)((uint8*)L$1 + 8ll) & 31ll) | ((*(int64*)((uint8*)L$1 + 8ll) & 480ll) + 32ll)) | ((*(int64*)((uint8*)L$1 + 8ll) & 261632ll) << 1ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) );
	N$1 = vr$13;
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = L$1;
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = *(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll);
	int64 vr$17 = ASTGETOFFSETCHILDOFS( L$1 );
	*(int64*)((uint8*)N$1 + 40ll) = vr$17;
	if( *(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll) == (struct $8FBSYMBOL*)0ull ) goto label$19;
	{
		*($12FB_SYMBSTATS*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll) + 16ll) = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll) + 16ll) | 2ll;
	}
	label$19:;
	label$18:;
	fb$result$1 = N$1;
...
static void HREMOVENULLPTRCHECK( struct $7ASTNODE* L$1 )
{
	...
	label$30:;
	{
		$13AST_NODECLASS TMP$76$2;
		TMP$76$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$76$2 != 32ll ) goto label$33;
		label$34:;
		{
		...
		label$36:;
		{
			label$37:;
			{
				...
				{
					$13AST_NODECLASS TMP$77$5;
					TMP$77$5 = *($13AST_NODECLASS*)T$1;
					if( TMP$77$5 != 32ll ) goto label$41;
					label$42:;
					{
...
// Total compilation time: 0.03342489199712873 seconds.
