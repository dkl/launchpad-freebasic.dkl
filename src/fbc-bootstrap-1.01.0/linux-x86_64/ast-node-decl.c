// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-decl.bas started at 16:30:09 on 02-28-2015
...
struct $7ASTNODE* ASTNEWDECL( struct $8FBSYMBOL* SYM$1, int64 DO_DEFAULTINIT$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = SYM$1;
	...
	{
		struct $7ASTNODE* vr$4 = HDEFAULTINIT( SYM$1 );
...
struct $6IRVREG* ASTLOADDECL( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$31;
	{
		...
		{
			(*(tmp$40*)((uint8*)&IR$ + 352ll))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) );
		}
		label$33:;
		label$32:;
	}
...
__attribute__(( constructor )) static void fb_ctor__astznodezdecl( void )
{
	label$0:;
	label$1:;
}
...
static struct $7ASTNODE* HCTORLIST( struct $8FBSYMBOL* SYM$1 )
{
	...
	struct $8FBSYMBOL* vr$2 = SYMBADDTEMPVAR( 7ll, (struct $8FBSYMBOL*)0ull );
	CNT$1 = vr$2;
	struct $8FBSYMBOL* vr$3 = SYMBADDLABEL( (uint8*)0ull, 4ll );
	LABEL$1 = vr$3;
	struct $8FBSYMBOL* vr$17 = SYMBADDTEMPVAR( (((*(int64*)((uint8*)SYM$1 + 48ll) & 511ll) & 31ll) | (((*(int64*)((uint8*)SYM$1 + 48ll) & 511ll) & 480ll) + 32ll)) | (((*(int64*)((uint8*)SYM$1 + 48ll) & 511ll) & 261632ll) << 1ll), SUBTYPE$1 );
	THIS_$1 = vr$17;
	struct $7ASTNODE* vr$18 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$19 = ASTNEWADDROF( vr$18 );
	struct $7ASTNODE* vr$20 = _Z17ASTBUILDVARASSIGNP8FBSYMBOLP7ASTNODEl( THIS_$1, vr$19, 64ll );
	struct $7ASTNODE* vr$21 = ASTNEWLINK( TREE$1, vr$20, -1ll );
	TREE$1 = vr$21;
	struct $7ASTNODE* vr$22 = ASTBUILDFORBEGIN( TREE$1, CNT$1, LABEL$1, 0ll, -1ll );
	TREE$1 = vr$22;
	struct $7ASTNODE* vr$23 = ASTBUILDVARDEREF( THIS_$1 );
	struct $7ASTNODE* vr$25 = ASTBUILDCTORCALL( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 56ll), vr$23 );
	struct $7ASTNODE* vr$26 = ASTNEWLINK( TREE$1, vr$25, -1ll );
	TREE$1 = vr$26;
	struct $7ASTNODE* vr$27 = ASTBUILDVARINC( THIS_$1, 1ll );
	struct $7ASTNODE* vr$28 = ASTNEWLINK( TREE$1, vr$27, -1ll );
	TREE$1 = vr$28;
	struct $7ASTNODE* vr$30 = ASTNEWCONSTI( *(int64*)((uint8*)SYM$1 + 120ll), 7ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$31 = ASTBUILDFOREND( TREE$1, CNT$1, LABEL$1, vr$30 );
	TREE$1 = vr$31;
	fb$result$1 = TREE$1;
	label$11:;
	return fb$result$1;
...
static struct $7ASTNODE* HDEFAULTINIT( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$15:;
	label$14:;
	if( (*(int64*)((uint8*)SYM$1 + 16ll) & 2048ll) == 0ll ) goto label$17;
	{
		goto label$13;
	}
	label$17:;
	label$16:;
	int64 vr$7 = SYMBHASDEFCTOR( SYM$1 );
	if( vr$7 == 0ll ) goto label$19;
	{
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 16777216ll) == 0ll ) goto label$21;
		{
			goto label$13;
		}
		label$21:;
		label$20:;
		if( *(int64*)((uint8*)SYM$1 + 96ll) != 0ll ) goto label$23;
		{
			struct $7ASTNODE* vr$14 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			struct $7ASTNODE* vr$16 = ASTBUILDCTORCALL( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 56ll), vr$14 );
			fb$result$1 = vr$16;
		}
		goto label$22;
		label$23:;
		{
			struct $7ASTNODE* vr$17 = HCTORLIST( SYM$1 );
			fb$result$1 = vr$17;
		}
		label$22:;
		goto label$13;
	...
	label$19:;
	label$18:;
	struct $7ASTNODE* vr$21 = ASTNEWCONSTI( *(int64*)((uint8*)SYM$1 + 72ll) * *(int64*)((uint8*)SYM$1 + 120ll), 7ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$22 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$23 = ASTNEWMEM( 106ll, vr$22, vr$21, 0ll );
	fb$result$1 = vr$23;
	label$13:;
	return fb$result$1;
}

// Total compilation time: 0.02707289252430201 seconds.
