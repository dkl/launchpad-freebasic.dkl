// Compilation of FreeBASIC-1.01.0-source/src/compiler/rtl-mem.bas started at 16:30:14 on 02-28-2015
...
static struct $14FB_RTL_PROCDEF FUNCDATA$[10] = { { (uint8*)"fb_NullPtrChk", (uint8*)0ull, 32ll, -1ll, (tmp$28)0ull, 2048ll, 3ll, { { 32ll, 1ll, 0ll }, { 10ll, 1ll, 0ll }, { 35ll, 1ll, 0ll } } }, { (uint8*)"fb_MemSwap", (uint8*)0ull, 0ll, -1ll, (tmp$28)0ull, 0ll, 3ll, { { 0ll, 2ll, 0ll }, { 0ll, 2ll, 0ll }, { 7ll, 1ll, 0ll } } }, { (uint8*)"fb_MemCopyClear", (uint8*)0ull, 0ll, -1ll, (tmp$28)0ull, 0ll, 4ll, { { 0ll, 2ll, 0ll }, { 7ll, 1ll, 0ll }, { 0ll, 2ll, 0ll }, { 7ll, 1ll, 0ll } } }, { (uint8*)"fre", (uint8*)"fb_GetMemAvail", 8ll, -1ll, (tmp$28)0ull, 0ll, 1ll, { { 10ll, 1ll, -1ll, 0ll } } }, { (uint8*)"allocate", (uint8*)"malloc", 32ll, 3ll, (tmp$28)0ull, 128ll, 1ll, { { 8ll, 1ll, 0ll } } }, { (uint8*)"callocate", (uint8*)"calloc", 32ll, 3ll, (tmp$28)0ull, 128ll, 2ll, { { 8ll, 1ll, 0ll }, { 8ll, 1ll, -1ll, 1ll } } }, { (uint8*)"reallocate", (uint8*)"realloc", 32ll, 3ll, (tmp$28)0ull, 128ll, 2ll, { { 32ll, 1ll, 0ll }, { 8ll, 1ll, 0ll } } }, { (uint8*)"deallocate", (uint8*)"free", 0ll, 3ll, (tmp$28)0ull, 128ll, 1ll, { { 32ll, 1ll, 0ll } } }, { (uint8*)"clear", (uint8*)"memset", 32ll, 3ll, (tmp$28)0ull, 0ll, 3ll, { { 0ll, 2ll, 0ll }, { 10ll, 1ll, -1ll, 0ll }, { 8ll, 1ll, 0ll } } }, { (uint8*)0ull } };
...
struct $7ASTNODE* RTLNULLPTRCHECK( struct $7ASTNODE* P$1, int64 LINENUM$1, uint8* MODULE$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_NullPtrChk", 133ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWCONV( 32ll, (struct $8FBSYMBOL*)0ull, P$1, 0ll, (int64*)0ull );
	...
	label$17:;
	label$16:;
	struct $7ASTNODE* vr$6 = ASTNEWCONSTI( LINENUM$1, 7ll, (struct $8FBSYMBOL*)0ull );
...
int64 RTLMEMSWAP( struct $7ASTNODE* DST$1, struct $7ASTNODE* SRC$1 )
{
	...
	fb$result$1 = 0ll;
	struct $7ASTNODE* PROC$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_MemSwap", 210ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	int64 BYTES$1;
	...
	label$25:;
	label$24:;
	struct $7ASTNODE* vr$6 = ASTNEWARG( PROC$1, SRC$1, 2147483648ll, -1ll );
	if( vr$6 != (struct $7ASTNODE*)0ull ) goto label$27;
	{
		goto label$23;
	}
	label$27:;
	label$26:;
	struct $7ASTNODE* vr$8 = ASTNEWCONSTI( BYTES$1, 7ll, (struct $8FBSYMBOL*)0ull );
...
int64 RTLMEMCOPYCLEAR( struct $7ASTNODE* DSTEXPR$1, int64 DSTLEN$1, struct $7ASTNODE* SRCEXPR$1, int64 SRCLEN$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = 0ll;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_MemCopyClear", 211ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	...
	label$33:;
	label$32:;
	struct $7ASTNODE* vr$5 = ASTNEWCONSTI( DSTLEN$1, 7ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$6 = ASTNEWARG( PROC$1, vr$5, 2147483648ll, -1ll );
	if( vr$6 != (struct $7ASTNODE*)0ull ) goto label$35;
	{
		goto label$31;
	}
	label$35:;
	label$34:;
	struct $7ASTNODE* vr$8 = ASTNEWARG( PROC$1, SRCEXPR$1, 2147483648ll, -1ll );
	...
	label$37:;
	label$36:;
	struct $7ASTNODE* vr$10 = ASTNEWCONSTI( SRCLEN$1, 7ll, (struct $8FBSYMBOL*)0ull );
...
struct $7ASTNODE* RTLMEMNEWOP( int64 OP$1, struct $7ASTNODE* LEN_EXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$53:;
	if( TMP$93$1 != 18ll ) goto label$44;
	{
		struct $8FBSYMBOL* vr$6 = SYMBGETCOMPOPOVLHEAD( SUBTYPE$1, *($6AST_OP*)(((uint8*)AST_OPTB$ + (OP$1 << 5ll)) + 24ll) );
		SYM$1 = vr$6;
		if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$46;
		{
			int64 vr$8 = SYMBCHECKACCESS( SYM$1 );
			if( vr$8 != 0ll ) goto label$48;
			{
	...
	{
		struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"allocate", 212ll );
		SYM$1 = vr$11;
	}
	label$50:;
	label$49:;
	struct $7ASTNODE* vr$12 = ASTNEWCALL( SYM$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$12;
	struct $7ASTNODE* vr$13 = ASTNEWARG( PROC$1, LEN_EXPR$1, 2147483648ll, -1ll );
	if( vr$13 != (struct $7ASTNODE*)0ull ) goto label$52;
	{
		goto label$41;
	}
	label$52:;
...
struct $7ASTNODE* RTLMEMDELETEOP( int64 OP$1, struct $7ASTNODE* PTR_EXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$67:;
	if( TMP$94$1 != 18ll ) goto label$58;
	{
		struct $8FBSYMBOL* vr$6 = SYMBGETCOMPOPOVLHEAD( SUBTYPE$1, *($6AST_OP*)(((uint8*)AST_OPTB$ + (OP$1 << 5ll)) + 24ll) );
		SYM$1 = vr$6;
		if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$60;
		{
			int64 vr$8 = SYMBCHECKACCESS( SYM$1 );
			if( vr$8 != 0ll ) goto label$62;
			{
				ERRREPORT( 201ll, 0ll, (uint8*)0ull );
			}
			label$62:;
	...
	label$57:;
	if( SYM$1 != (struct $8FBSYMBOL*)0ull ) goto label$64;
	{
		struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"deallocate", 213ll );
		SYM$1 = vr$11;
	}
	label$64:;
	label$63:;
	struct $7ASTNODE* vr$12 = ASTNEWCALL( SYM$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$12;
	struct $7ASTNODE* vr$13 = ASTNEWARG( PROC$1, PTR_EXPR$1, 2147483648ll, -1ll );
	if( vr$13 != (struct $7ASTNODE*)0ull ) goto label$66;
	{
		goto label$55;
	}
	label$66:;
...
// Total compilation time: 0.03282099834177643 seconds.
