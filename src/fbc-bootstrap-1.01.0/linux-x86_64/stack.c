// Compilation of FreeBASIC-1.01.0-source/src/compiler/stack.bas started at 16:30:15 on 02-28-2015
...
void* STACKPUSH( struct $6TSTACK* STK$1 )
{
	...
	label$27:;
	{
		...
		{
			HALLOCTB( STK$1, (int64)(*(uint64*)((uint8*)STK$1 + 16ll) >> 2ull) );
		}
		label$29:;
		label$28:;
...
static int64 HALLOCTB( struct $6TSTACK* STK$1, int64 NODES$1 )
{
	...
	{
		void* vr$7 = XCALLOCATE( (int32)(NODES$1 * *(int64*)((uint8*)STK$1 + 24ll)) );
		NODETB$1 = (struct $10TSTACKNODE*)vr$7;
	}
	goto label$12;
	label$13:;
	{
		void* vr$11 = XALLOCATE( (int32)(NODES$1 * *(int64*)((uint8*)STK$1 + 24ll)) );
		NODETB$1 = (struct $10TSTACKNODE*)vr$11;
	}
	label$12:;
	void* vr$12 = XALLOCATE( 24 );
	TB$1 = (struct $8TSTACKTB*)vr$12;
...
// Total compilation time: 0.001666903262957931 seconds.
