// Compilation of FreeBASIC-1.01.0-source/src/compiler/parser-quirk-iif.bas started at 16:30:13 on 02-28-2015
...
struct $7ASTNODE* CIIFFUNCT( void )
{
	...
	label$19:;
	label$18:;
	int64 vr$9 = ASTDTORLISTSCOPEEND(  );
	TRUECOOKIE$1 = vr$9;
	int64 vr$10 = LEXGETTOKEN( 0ll );
	if( vr$10 == 44ll ) goto label$21;
	{
		ERRREPORT( 16ll, 0ll, (uint8*)0ull );
	}
	goto label$20;
	...
	label$20:;
	ASTDTORLISTSCOPEBEGIN( 0ll );
	struct $7ASTNODE* vr$14 = HMATCHEXPR( *(int64*)((uint8*)TRUEXPR$1 + 8ll) & 511ll );
	FALSEXPR$1 = vr$14;
	...
	label$23:;
	label$22:;
	int64 vr$16 = ASTDTORLISTSCOPEEND(  );
	FALSECOOKIE$1 = vr$16;
	int64 vr$17 = LEXGETTOKEN( 0ll );
	if( vr$17 == 41ll ) goto label$25;
	{
	...
	label$24:;
	struct $7ASTNODE* vr$19 = ASTNEWIIF( EXPR$1, TRUEXPR$1, TRUECOOKIE$1, FALSEXPR$1, FALSECOOKIE$1 );
	EXPR$1 = vr$19;
...
__attribute__(( constructor )) static void fb_ctor__parserzquirkziif( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.02833404310513288 seconds.
