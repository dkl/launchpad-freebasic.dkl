// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-idx.bas started at 16:30:09 on 02-28-2015
...
struct $7ASTNODE* ASTNEWIDX( struct $7ASTNODE* VAR_$1, struct $7ASTNODE* IDX$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		DTYPE$1 = *(int64*)((uint8*)VAR_$1 + 8ll);
		SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)VAR_$1 + 16ll);
	}
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$4 = ASTNEWNODE( 18ll, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$4;
...
struct $6IRVREG* ASTLOADIDX( struct $7ASTNODE* N$1 )
{
	...
	if( VAR_$1 != (struct $7ASTNODE*)0ull ) goto label$17;
	{
	...
	if( IDX$1 == (struct $7ASTNODE*)0ull ) goto label$19;
	{
		struct $6IRVREG* vr$5 = ASTLOAD( IDX$1 );
		VIDX$1 = vr$5;
	}
	goto label$18;
	label$19:;
	...
	label$18:;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$21;
	{
		S$1 = *(struct $8FBSYMBOL**)((uint8*)VAR_$1 + 24ll);
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 16ll) = *(int64*)((uint8*)S$1 + 16ll) | 2ll;
		OFS$1 = *(int64*)((uint8*)N$1 + 40ll);
		if( (int64)-((*(int64*)((uint8*)S$1 + 8ll) & 65540ll) != 0ll) != 0ll ) goto label$23;
		{
			OFS$1 = ((OFS$1 + *(int64*)((uint8*)S$1 + 112ll)) + *(int64*)((uint8*)S$1 + 80ll)) + *(int64*)((uint8*)VAR_$1 + 40ll);
		}
		goto label$22;
		label$23:;
		{
		...
		label$22:;
		if( VIDX$1 == (struct $6IRVREG*)0ull ) goto label$25;
		{
			if( (int64)-(*(int64*)VIDX$1 == 4ll) != 0ll ) goto label$27;
			{
				(*(tmp$50*)((uint8*)&IR$ + 248ll))( VIDX$1 );
			}
			label$27:;
			label$26:;
			struct $6IRVREG* vr$30 = (*(tmp$68*)((uint8*)&IR$ + 504ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), S$1, OFS$1, *(int64*)((uint8*)N$1 + 48ll), VIDX$1 );
			VR$1 = vr$30;
		}
		goto label$24;
		label$25:;
		{
			struct $6IRVREG* vr$34 = (*(tmp$67*)((uint8*)&IR$ + 496ll))( *(int64*)((uint8*)N$1 + 8ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), S$1, OFS$1 );
			VR$1 = vr$34;
		}
		label$24:;
...
__attribute__(( constructor )) static void fb_ctor__astznodezidx( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.02705488295760006 seconds.
