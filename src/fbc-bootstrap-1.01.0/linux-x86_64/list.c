// Compilation of FreeBASIC-1.01.0-source/src/compiler/list.bas started at 16:30:11 on 02-28-2015
...
void* XREALLOCATE( void* OLD$1, int32 SIZE$1 )
{
	...
	label$14:;
	void* P$1;
	void* vr$2 = realloc( OLD$1, (uint64)SIZE$1 );
	P$1 = vr$2;
...
void LISTALLOCTB( struct $5TLIST* LIST$1, int64 NODES$1 )
{
	...
	{
		void* vr$6 = XCALLOCATE( (int32)(NODES$1 * *(int64*)((uint8*)LIST$1 + 24ll)) );
		NODETB$1 = (struct $9TLISTNODE*)vr$6;
	}
	goto label$26;
	label$27:;
	{
		void* vr$10 = XALLOCATE( (int32)(NODES$1 * *(int64*)((uint8*)LIST$1 + 24ll)) );
		NODETB$1 = (struct $9TLISTNODE*)vr$10;
	}
	label$26:;
	void* vr$11 = XALLOCATE( 24 );
	TB$1 = (struct $7TLISTTB*)vr$11;
...
void* LISTNEWNODE( struct $5TLIST* LIST$1 )
{
	...
	{
		LISTALLOCTB( LIST$1, (int64)(*(uint64*)((uint8*)LIST$1 + 16ll) >> 2ull) );
	}
	label$41:;
	label$40:;
	NODE$1 = *(struct $9TLISTNODE**)((uint8*)LIST$1 + 32ll);
...
void STRLISTAPPEND( struct $5TLIST* LIST$1, FBSTRING* S$1 )
{
	...
	P$1 = (FBSTRING*)vr$0;
	FBSTRING* vr$1 = fb_StrAssign( (void*)P$1, -1ll, (void*)S$1, -1ll, 0 );
	label$75:;
}
...
static void FATALOUTOFMEMORY( void )
{
	label$2:;
	label$4:;
	void* vr$0 = fb_ErrorThrowEx( 4, 10, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/list.bas", (void*)0ull, (void*)0ull );
	goto *vr$0;
	label$5:;
	label$3:;
}

// Total compilation time: 0.003406953765079379 seconds.
