// Compilation of FreeBASIC-1.01.0-source/src/compiler/objinfo.bas started at 16:30:11 on 02-28-2015
...
static void HLOADFILE( FBSTRING* FILENAME$1, struct $10DATABUFFER* BUF$1 )
{
	...
	*(int64*)((uint8*)BUF$1 + 8ll) = 0ll;
	...
	void* vr$23 = fb_ErrorThrowAt( 611, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/objinfo.bas", (void*)0ull, (void*)0ull );
	goto *vr$23;
	label$185:;
	label$178:;
}
...
// Total compilation time: 0.01606991852167994 seconds.
