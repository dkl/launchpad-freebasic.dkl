// Compilation of FreeBASIC-1.01.0-source/src/compiler/rtl-oop.bas started at 16:30:15 on 02-28-2015
...
static struct $14FB_RTL_PROCDEF FUNCDATA$[4] = { { (uint8*)"fb_IsTypeOf", (uint8*)0ull, 10ll, -1ll, (tmp$28)0ull, 0ll, 2ll, { { 0ll, 2ll, 0ll }, { 0ll, 2ll, 0ll } } }, { (uint8*)0ull } };
...
struct $7ASTNODE* RTLOOPISTYPEOF( struct $7ASTNODE* INST$1, struct $7ASTNODE* RTTI$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_IsTypeOf", 134ll );
	...
	label$17:;
	label$16:;
	struct $7ASTNODE* vr$5 = ASTNEWARG( PROC$1, RTTI$1, 2147483648ll, -1ll );
...
// Total compilation time: 0.03047888644505292 seconds.
