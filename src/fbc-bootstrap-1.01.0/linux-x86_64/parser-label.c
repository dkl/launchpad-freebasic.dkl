// Compilation of FreeBASIC-1.01.0-source/src/compiler/parser-label.bas started at 16:30:13 on 02-28-2015
...
int64 CLABEL( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		TMP$85$2 = (uint64)vr$1;
		goto label$13;
		label$14:;
		{
			if( (int64)-((*(int64*)((uint8*)&ENV$ + 1152ll) & 1048576ll) != 0ll) != 0ll ) goto label$16;
			{
				ERRREPORTNOTALLOWED( 1048576ll, 145ll, (uint8*)0ull );
			...
			label$16:;
			{
				...
				struct $8FBSYMBOL* vr$6 = SYMBADDLABEL( vr$5, 68ll );
				L$1 = vr$6;
		...
		label$19:;
		{
			...
			if( vr$9 != 258ll ) goto label$21;
			{
				...
				if( vr$13 == (struct $8FBSYMBOL*)0ull ) goto label$23;
				{
					goto label$11;
				}
				label$23:;
				...
				struct $8FBSYMBOL* vr$16 = SYMBADDLABEL( vr$15, 68ll );
				L$1 = vr$16;
		...
		goto label$12;
		label$13:;
		static const void* tmp$86[4ll] = {
			&&label$19,
			&&label$12,
			&&label$12,
			&&label$14,
		};
		if( TMP$85$2 > 3ll ) goto label$12;
		goto *tmp$86[TMP$85$2 - 0ll];
		label$12:;
	}
	if( L$1 == (struct $8FBSYMBOL*)0ull ) goto label$27;
	{
		struct $7ASTNODE* vr$19 = ASTNEWLABEL( L$1, -1ll );
		ASTADD( vr$19 );
		*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 198000ll) = L$1;
		fb$result$1 = -1ll;
	}
	label$27:;
	label$26:;
...
__attribute__(( constructor )) static void fb_ctor__parserzlabel( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.0304358935682103 seconds.
