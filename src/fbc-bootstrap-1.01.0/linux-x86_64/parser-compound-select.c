// Compilation of FreeBASIC-1.01.0-source/src/compiler/parser-compound-select.bas started at 16:30:11 on 02-28-2015
...
void CSELECTSTMTBEGIN( void )
{
	...
	if( vr$2 != 375ll ) goto label$19;
	{
		LEXSKIPTOKEN( 0ll );
		int64 vr$4 = HMATCH( 335ll );
		if( vr$4 == 0ll ) goto label$21;
		{
			CSELCONSTSTMTBEGIN(  );
			goto label$15;
		}
	...
	struct $7ASTNODE* vr$6 = ASTSCOPEBEGIN(  );
	OUTERSCOPENODE$1 = vr$6;
	...
	label$25:;
	label$24:;
	if( (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) != 18ll ) goto label$27;
	{
	...
	label$27:;
	label$26:;
	struct $8FBSYMBOL* vr$15 = SYMBADDLABEL( (uint8*)0ull, 0ll );
	EL$1 = vr$15;
	...
	struct $7ASTNODE* vr$18 = ASTGETEFFECTIVENODE( EXPR$1 );
	EFFECTIVEEXPR$1 = vr$18;
	if( *(int64*)EFFECTIVEEXPR$1 != 17ll ) goto label$29;
	{
		SYM$1 = *(struct $8FBSYMBOL**)((uint8*)EFFECTIVEEXPR$1 + 24ll);
		struct $7ASTNODE* vr$22 = ASTREBUILDWITHOUTEFFECTIVEPART( EXPR$1 );
		ASTADD( vr$22 );
	}
	goto label$28;
	label$29:;
	{
		int64 TMP$88$2;
		{
			...
			label$47:;
			TMP$87$3 = TMP$86$3;
			if( TMP$87$3 == 17ll ) goto label$33;
			label$34:;
			if( TMP$87$3 != 3ll ) goto label$32;
			label$33:;
			{
				DTYPE$1 = 16ll;
			}
		...
		OPTIONS$1 = 0ll;
		if( (int64)-((*(int64*)((uint8*)&ENV$ + 1152ll) & 2ll) != 0ll) != 0ll ) goto label$36;
		{
		...
		label$48:;
		if( TMP$88$2 == 6ll ) goto label$39;
		{
			int64 TMP$89$3;
			struct $8FBSYMBOL* vr$36 = SYMBADDIMPLICITVAR( DTYPE$1, SUBTYPE$1, OPTIONS$1 );
			SYM$1 = vr$36;
			...
			label$49:;
			if( TMP$89$3 == 16ll ) goto label$42;
			{
			...
			{
				struct $7ASTNODE* vr$46 = ASTNEWDECL( SYM$1, -1ll );
				ASTADDUNSCOPED( vr$46 );
				struct $7ASTNODE* vr$47 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
				struct $7ASTNODE* vr$48 = ASTNEWASSIGN( vr$47, EXPR$1, 0ll );
				ASTADD( vr$48 );
			}
			goto label$43;
			label$44:;
			{
				struct $7ASTNODE* vr$49 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
				struct $7ASTNODE* vr$50 = ASTNEWASSIGN( vr$49, EXPR$1, 64ll );
				struct $7ASTNODE* vr$51 = ASTNEWDECL( SYM$1, 0ll );
				struct $7ASTNODE* vr$52 = ASTNEWLINK( vr$51, vr$50, -1ll );
				ASTADD( vr$52 );
			}
			label$43:;
		}
		...
		label$39:;
		{
			struct $8FBSYMBOL* vr$53 = SYMBADDIMPLICITVAR( 38ll, (struct $8FBSYMBOL*)0ull, OPTIONS$1 );
			SYM$1 = vr$53;
			*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 16ll) = *(int64*)((uint8*)SYM$1 + 16ll) | 16777216ll;
			if( (OPTIONS$1 & 2ll) == 0ll ) goto label$46;
			{
				struct $7ASTNODE* vr$59 = ASTNEWDECL( SYM$1, -1ll );
				ASTADDUNSCOPED( vr$59 );
				struct $7ASTNODE* vr$60 = ASTBUILDFAKEWSTRINGASSIGN( SYM$1, EXPR$1, 0ll );
				ASTADD( vr$60 );
			}
			goto label$45;
			label$46:;
			{
				struct $7ASTNODE* vr$61 = ASTBUILDFAKEWSTRINGASSIGN( SYM$1, EXPR$1, 64ll );
				struct $7ASTNODE* vr$62 = ASTNEWDECL( SYM$1, 0ll );
				struct $7ASTNODE* vr$63 = ASTNEWLINK( vr$62, vr$61, -1ll );
				ASTADD( vr$63 );
			}
			label$45:;
		}
	...
	*(int64*)((uint8*)STK$1 + 40ll) = 0ll;
	struct $8FBSYMBOL* vr$68 = SYMBADDLABEL( (uint8*)0ull, 0ll );
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 80ll) = vr$68;
...
void CSELECTSTMTNEXT( void )
{
	...
	*($15FB_CMPSTMT_MASK*)((uint8*)STK$1 + 8ll) = 1ll;
	...
	{
		struct $7ASTNODE* vr$14 = ASTNEWBRANCH( 97ll, *(struct $8FBSYMBOL**)((uint8*)STK$1 + 88ll), (struct $7ASTNODE*)0ull );
		ASTADD( vr$14 );
		struct $7ASTNODE* vr$16 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 80ll), -1ll );
		ASTADD( vr$16 );
		struct $8FBSYMBOL* vr$17 = SYMBADDLABEL( (uint8*)0ull, 4ll );
		*(struct $8FBSYMBOL**)((uint8*)STK$1 + 80ll) = vr$17;
	}
	label$88:;
	label$87:;
	int64 vr$19 = LEXGETTOKEN( 0ll );
	if( vr$19 != 268ll ) goto label$90;
	{
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$21 = ASTSCOPEBEGIN(  );
		*(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) = vr$21;
	...
	label$91:;
	{
		HCASEEXPRESSION( (struct $9FBCASECTX*)((uint8*)((uint8*)&CTX$ + ((CNTBASE$1 + CNT$1) << 5ll)) + 8ll), *(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll) );
		CNT$1 = CNT$1 + 1ll;
		int64 vr$30 = LEXGETTOKEN( 0ll );
		if( vr$30 == 44ll ) goto label$95;
		{
			goto label$92;
		}
		label$95:;
	...
	*(int64*)&CTX$ = *(int64*)&CTX$ + CNT$1;
	struct $8FBSYMBOL* vr$33 = SYMBADDLABEL( (uint8*)0ull, 4ll );
	IL$1 = vr$33;
	{
		I$1 = 0ll;
		int64 TMP$93$2;
		...
		label$99:;
		{
			...
			{
				struct $8FBSYMBOL* vr$37 = SYMBADDLABEL( (uint8*)0ull, 0ll );
				NL$1 = vr$37;
			}
			goto label$100;
			label$101:;
			...
			label$100:;
			if( *(int64*)((uint8*)((uint8*)&CTX$ + ((CNTBASE$1 + I$1) << 5ll)) + 8ll) == 3ll ) goto label$103;
			{
				int64 vr$50 = HFLUSHCASEEXPR( (struct $9FBCASECTX*)((uint8*)((uint8*)&CTX$ + ((CNTBASE$1 + I$1) << 5ll)) + 8ll), *(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll), IL$1, NL$1, (int64)-(I$1 == (CNT$1 + -1ll)) );
				if( vr$50 != 0ll ) goto label$105;
				{
			...
			{
				struct $7ASTNODE* vr$54 = ASTNEWLABEL( NL$1, -1ll );
				ASTADD( vr$54 );
			}
			label$107:;
			label$106:;
		...
		I$1 = I$1 + 1ll;
		label$96:;
		if( I$1 <= TMP$93$2 ) goto label$99;
		label$98:;
	}
	*(int64*)&CTX$ = *(int64*)&CTX$ - CNT$1;
	struct $7ASTNODE* vr$58 = ASTNEWLABEL( IL$1, -1ll );
	ASTADD( vr$58 );
	struct $7ASTNODE* vr$59 = ASTSCOPEBEGIN(  );
	*(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) = vr$59;
...
void CSELECTSTMTEND( void )
{
	...
	label$117:;
	label$116:;
	struct $7ASTNODE* vr$10 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 80ll), -1ll );
	ASTADD( vr$10 );
	struct $7ASTNODE* vr$12 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 88ll), -1ll );
	ASTADD( vr$12 );
...
static void HCASEEXPRESSION( struct $9FBCASECTX* CASECTX$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	*(int64*)((uint8*)CASECTX$1 + 8ll) = 45ll;
	...
	if( vr$1 != 272ll ) goto label$53;
	{
		...
		int64 vr$4 = HFBRELOP2IRRELOP( vr$3 );
		*(int64*)((uint8*)CASECTX$1 + 8ll) = vr$4;
		LEXSKIPTOKEN( 0ll );
	...
	label$52:;
	struct $7ASTNODE* vr$8 = CEXPRESSION(  );
	*(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll) = vr$8;
	if( *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll) != (struct $7ASTNODE*)0ull ) goto label$55;
	{
		int64 TMP$90$2;
		ERRREPORT( 9ll, 0ll, (uint8*)0ull );
		if( (*(int64*)((uint8*)SYM$1 + 16ll) & 16777216ll) == 0ll ) goto label$56;
		TMP$90$2 = 6ll;
		goto label$120;
		label$56:;
		TMP$90$2 = *(int64*)((uint8*)SYM$1 + 48ll) & 511ll;
		label$120:;
		struct $7ASTNODE* vr$17 = ASTNEWCONSTZ( TMP$90$2, (struct $8FBSYMBOL*)0ull );
		*(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll) = vr$17;
	}
	label$55:;
	label$54:;
	int64 vr$19 = LEXGETTOKEN( 0ll );
	if( vr$19 != 284ll ) goto label$58;
	{
		LEXSKIPTOKEN( 0ll );
		...
		label$60:;
		{
			...
			*(struct $7ASTNODE**)((uint8*)CASECTX$1 + 24ll) = vr$25;
...
{
	struct $7ASTNODE* TMP$91$1;
	int64 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$63:;
	struct $7ASTNODE* EXPR$1;
	if( (*(int64*)((uint8*)SYM$1 + 16ll) & 16777216ll) == 0ll ) goto label$65;
	struct $7ASTNODE* vr$4 = ASTBUILDFAKEWSTRINGACCESS( SYM$1 );
	TMP$91$1 = vr$4;
	goto label$121;
	label$65:;
	...
	if( *(int64*)CASECTX$1 == 1ll ) goto label$67;
	{
		...
		{
			int64 vr$11 = ASTGETINVERSELOGOP( *(int64*)((uint8*)CASECTX$1 + 8ll) );
			struct $7ASTNODE* vr$12 = ASTNEWBOP( vr$11, EXPR$1, *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll), NXTLABEL$1, 0ll );
			EXPR$1 = vr$12;
		}
		goto label$68;
		label$69:;
		{
			struct $7ASTNODE* vr$15 = ASTNEWBOP( *(int64*)((uint8*)CASECTX$1 + 8ll), EXPR$1, *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll), INILABEL$1, 0ll );
			EXPR$1 = vr$15;
		}
		label$68:;
	}
	...
	label$67:;
	{
		struct $7ASTNODE* TMP$92$2;
		struct $7ASTNODE* vr$17 = ASTNEWBOP( 47ll, EXPR$1, *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll), NXTLABEL$1, 0ll );
		EXPR$1 = vr$17;
		...
		label$70:;
		ASTADD( EXPR$1 );
		if( (*(int64*)((uint8*)SYM$1 + 16ll) & 16777216ll) == 0ll ) goto label$72;
		struct $7ASTNODE* vr$22 = ASTBUILDFAKEWSTRINGACCESS( SYM$1 );
		TMP$92$2 = vr$22;
		goto label$122;
		label$72:;
		struct $7ASTNODE* vr$23 = ASTNEWVAR( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
		TMP$92$2 = vr$23;
		label$122:;
		EXPR$1 = TMP$92$2;
		if( ISLAST$1 == 0ll ) goto label$74;
		{
			struct $7ASTNODE* vr$26 = ASTNEWBOP( 46ll, EXPR$1, *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 24ll), NXTLABEL$1, 0ll );
			EXPR$1 = vr$26;
		}
		goto label$73;
		label$74:;
		{
			struct $7ASTNODE* vr$28 = ASTNEWBOP( 50ll, EXPR$1, *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 24ll), INILABEL$1, 0ll );
			EXPR$1 = vr$28;
		}
		label$73:;
	}
...
// Total compilation time: 0.04673889721743762 seconds.
