// Compilation of FreeBASIC-1.01.0-source/src/compiler/hash.bas started at 16:30:10 on 02-28-2015
...
void HASHINIT( struct $5THASH* HASH$1, int64 NODES$1, int64 DELSTR$1 )
{
	label$18:;
	LAZYINIT(  );
	void* vr$2 = XCALLOCATE( (int32)(NODES$1 << 4ll) );
...
uint64 HASHHASH( uint8* S$1 )
{
	...
	{
		INDEX$1 = ((uint64)(int64)*S$1 + (INDEX$1 << 5ll)) - INDEX$1;
...
void* HASHLOOKUPEX( struct $5THASH* HASH$1, uint8* SYMBOL$1, uint64 INDEX$1 )
{
	...
	LIST$1 = (struct $8HASHLIST*)((uint8*)*(struct $8HASHLIST**)HASH$1 + ((int64)INDEX$1 << 4ll));
	ITEM$1 = *(struct $8HASHITEM**)LIST$1;
	...
	{
		int32 vr$10 = fb_StrCompare( *(void**)ITEM$1, 0ll, (void*)SYMBOL$1, 0ll );
		if( (int64)vr$10 != 0ll ) goto label$47;
		{
...
struct $8HASHITEM* HASHADD( struct $5THASH* HASH$1, uint8* SYMBOL$1, void* USERDATA$1, uint64 INDEX$1 )
{
	...
	{
		uint64 vr$2 = HASHHASH( SYMBOL$1 );
		INDEX$1 = vr$2;
	}
	label$65:;
	label$64:;
	INDEX$1 = INDEX$1 % *(uint64*)((uint8*)HASH$1 + 8ll);
	struct $8HASHITEM* vr$8 = HASHNEWITEM( (struct $8HASHLIST*)((uint8*)*(struct $8HASHLIST**)HASH$1 + ((int64)INDEX$1 << 4ll)) );
	ITEM$1 = vr$8;
	fb$result$1 = ITEM$1;
...
void STRSETADD( struct $7TSTRSET* SET$1, FBSTRING* S$1, int64 USERDATA$1 )
{
	...
	label$77:;
	label$76:;
	void* vr$5 = HASHLOOKUP( (struct $5THASH*)((uint8*)SET$1 + 64ll), *(uint8**)S$1 );
	...
	label$79:;
	label$78:;
	void* vr$9 = LISTNEWNODE( (struct $5TLIST*)SET$1 );
	I$1 = (struct $11TSTRSETITEM*)vr$9;
	FBSTRING* vr$12 = fb_StrAssign( (void*)I$1, -1ll, (void*)S$1, -1ll, 0 );
	*(int64*)((uint8*)I$1 + 24ll) = USERDATA$1;
	int64 vr$16 = fb_StrLen( (void*)I$1, -1ll );
	if( vr$16 != 0ll ) goto label$81;
	{
		goto label$75;
	}
	label$81:;
	label$80:;
	uint64 vr$19 = HASHHASH( *(uint8**)I$1 );
	HASHADD( (struct $5THASH*)((uint8*)SET$1 + 64ll), *(uint8**)I$1, (void*)I$1, vr$19 );
	label$75:;
}
...
void STRSETEND( struct $7TSTRSET* SET$1 )
{
	...
	if( I$1 == (struct $11TSTRSETITEM*)0ull ) goto label$91;
	{
		...
		void* vr$8 = LISTGETNEXT( (void*)I$1 );
		I$1 = (struct $11TSTRSETITEM*)vr$8;
	}
	goto label$90;
	label$91:;
...
// Total compilation time: 0.004771983833052218 seconds.
