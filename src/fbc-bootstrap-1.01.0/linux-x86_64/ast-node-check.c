// Compilation of FreeBASIC-1.01.0-source/src/compiler/ast-node-check.bas started at 16:30:09 on 02-28-2015
...
struct $7ASTNODE* ASTNEWBOUNDCHK( struct $7ASTNODE* L$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1, int64 LINENUM$1, uint8* FILENAME$1 )
{
	...
	label$13:;
	label$12:;
	struct $7ASTNODE* vr$15 = ASTNEWNODE( 31ll, *(int64*)((uint8*)L$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) );
	N$1 = vr$15;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = L$1;
	struct $8FBSYMBOL* vr$19 = SYMBADDTEMPVAR( *(int64*)((uint8*)L$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) );
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = vr$19;
	struct $7ASTNODE* vr$22 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$23 = RTLARRAYBOUNDSCHECK( vr$22, LB$1, UB$1, LINENUM$1, FILENAME$1 );
...
struct $6IRVREG* ASTLOADBOUNDCHK( struct $7ASTNODE* N$1 )
{
	...
	label$25:;
	label$24:;
	struct $7ASTNODE* vr$8 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$9 = ASTNEWASSIGN( vr$8, L$1, 64ll );
	T$1 = vr$9;
	ASTLOAD( T$1 );
	ASTDELNODE( T$1 );
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$27;
	{
		...
		LABEL$1 = vr$12;
		struct $6IRVREG* vr$13 = (*(tmp$65*)((uint8*)&IR$ + 480ll))( 7ll, (struct $8FBSYMBOL*)0ull, 0ll );
		(*(tmp$48*)((uint8*)&IR$ + 216ll))( 45ll, VR$1, vr$13, (struct $6IRVREG*)0ull, LABEL$1 );
		(*(tmp$50*)((uint8*)&IR$ + 304ll))( VR$1 );
		(*(tmp$40*)((uint8*)&IR$ + 136ll))( LABEL$1 );
	}
	label$27:;
	label$26:;
	struct $7ASTNODE* vr$15 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	T$1 = vr$15;
	struct $6IRVREG* vr$16 = ASTLOAD( T$1 );
	fb$result$1 = vr$16;
	ASTDELNODE( T$1 );
	label$23:;
	return fb$result$1;
...
struct $7ASTNODE* ASTBUILDBOUNDCHK( struct $7ASTNODE* EXPR$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$28:;
	struct $7ASTNODE* vr$3 = ASTNEWBOUNDCHK( EXPR$1, LB$1, UB$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 843744ll) + 16712ll), (uint8*)((uint8*)&ENV$ + 488ll) );
	fb$result$1 = vr$3;
	label$29:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTNEWPTRCHK( struct $7ASTNODE* L$1, int64 LINENUM$1, uint8* FILENAME$1 )
{
	...
	struct $7ASTNODE* vr$5 = ASTNEWNODE( 32ll, DTYPE$1, SUBTYPE$1 );
	N$1 = vr$5;
	fb$result$1 = N$1;
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = L$1;
	struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( DTYPE$1, SUBTYPE$1 );
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) = vr$7;
	struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$11 = RTLNULLPTRCHECK( vr$10, LINENUM$1, FILENAME$1 );
	*(struct $7ASTNODE**)((uint8*)N$1 + 120ll) = vr$11;
	label$31:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTBUILDPTRCHK( struct $7ASTNODE* EXPR$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$40:;
	struct $7ASTNODE* vr$3 = ASTNEWPTRCHK( EXPR$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 843744ll) + 16712ll), (uint8*)((uint8*)&ENV$ + 488ll) );
	fb$result$1 = vr$3;
	label$41:;
	return fb$result$1;
}

__attribute__(( constructor )) static void fb_ctor__astznodezcheck( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.03822511399630457 seconds.
