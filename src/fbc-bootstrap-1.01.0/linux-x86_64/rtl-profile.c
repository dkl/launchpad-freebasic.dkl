// Compilation of FreeBASIC-1.01.0-source/src/compiler/rtl-profile.bas started at 16:30:15 on 02-28-2015
...
static struct $14FB_RTL_PROCDEF FUNCDATA$[3] = { { (uint8*)"fb_mcount", (uint8*)"mcount", 0ll, 3ll, (tmp$28)0ull, 0ll, 0ll }, { (uint8*)"fb__monstartup", (uint8*)"_monstartup", 0ll, 3ll, (tmp$28)0ull, 0ll, 0ll }, { (uint8*)0ull } };
...
struct $7ASTNODE* RTLPROFILECALL_MCOUNT( void )
{
	...
	label$14:;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_mcount", 323ll );
...
{
	label$16:;
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb__monstartup", 324ll );
...
// Total compilation time: 0.03381093207281083 seconds.
