// Compilation of FreeBASIC-1.01.0-source/src/compiler/parser-expr-binary.bas started at 16:30:12 on 02-28-2015
...
struct $7ASTNODE* CEXPRESSIONWITHNIDXARRAY( int64 ALLOW_NIDXARRAY$1 )
{
	...
	OLDCHECKARRAY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 288ll) & 2ll) != 0ll);
	...
	{
		{
			...
			goto label$29;
			label$30:;
			static const void* tmp$87[2ll] = {
				&&label$31,
				&&label$32,
			};
			if( TMP$86$3 < 290ll ) goto label$33;
			if( TMP$86$3 > 291ll ) goto label$33;
			goto *tmp$87[TMP$86$3 - 290ll];
			label$29:;
		}
		int64 vr$4 = LEXGETLOOKAHEAD( 1ll, 0ll );
		int64 vr$5 = HISASSIGNTOKEN( vr$4 );
		if( vr$5 == 0ll ) goto label$35;
		{
			goto label$27;
		}
		label$35:;
		...
		struct $7ASTNODE* vr$7 = CLOGEXPRESSION(  );
		EXPR$1 = vr$7;
		int64 vr$8 = ASTDTORLISTSCOPEEND(  );
		DTORLISTCOOKIE$1 = vr$8;
		...
		label$37:;
		label$36:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( OP$1, LOGEXPR$1, EXPR$1, (struct $8FBSYMBOL*)DTORLISTCOOKIE$1, 1ll );
		LOGEXPR$1 = vr$10;
	...
	{
		{
			...
			if( TMP$88$3 < 292ll ) goto label$52;
			if( TMP$88$3 > 294ll ) goto label$52;
			goto *tmp$89[TMP$88$3 - 292ll];
			label$47:;
		}
		int64 vr$4 = LEXGETLOOKAHEAD( 1ll, 0ll );
		int64 vr$5 = HISASSIGNTOKEN( vr$4 );
		if( vr$5 == 0ll ) goto label$54;
		{
			goto label$45;
		}
		label$54:;
		label$53:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$7 = CLOGOREXPRESSION(  );
		EXPR$1 = vr$7;
		...
		label$56:;
		label$55:;
		struct $7ASTNODE* vr$9 = ASTNEWBOP( OP$1, LOGEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		LOGEXPR$1 = vr$9;
...
struct $7ASTNODE* CLOGOREXPRESSION( void )
{
	...
	label$63:;
	{
		...
		int64 vr$6 = HISASSIGNTOKEN( vr$5 );
		if( vr$6 == 0ll ) goto label$69;
		{
			goto label$64;
		}
		label$69:;
		label$68:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$8 = CLOGANDEXPRESSION(  );
		EXPR$1 = vr$8;
		...
		label$71:;
		label$70:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( 35ll, LOGEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		LOGEXPR$1 = vr$10;
...
struct $7ASTNODE* CLOGANDEXPRESSION( void )
{
	...
	label$78:;
	{
		...
		label$83:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$8 = CRELEXPRESSION(  );
		EXPR$1 = vr$8;
		...
		label$86:;
		label$85:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( 34ll, LOGEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		LOGEXPR$1 = vr$10;
	...
	{
		{
			uint64 TMP$90$3;
			int64 vr$3 = LEXGETTOKEN( 0ll );
			TMP$90$3 = (uint64)vr$3;
			goto label$97;
			label$98:;
			{
				*(int64*)((uint8*)&PARSER$ + 312ll) = (int64)-(*(int64*)((uint8*)&PARSER$ + 280ll) == 0ll);
				if( (*(int64*)((uint8*)&PARSER$ + 288ll) & 256ll) == 0ll ) goto label$100;
				{
					goto label$94;
				}
				label$100:;
			...
			label$101:;
			{
				if( (*(int64*)((uint8*)&PARSER$ + 288ll) & 512ll) == 0ll ) goto label$103;
				{
					goto label$94;
				}
				label$103:;
			...
			if( TMP$90$3 < 299ll ) goto label$108;
			if( TMP$90$3 > 304ll ) goto label$108;
			goto *tmp$91[TMP$90$3 - 299ll];
			label$96:;
		}
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$9 = CISEXPRESSION(  );
		EXPR$1 = vr$9;
		...
		label$110:;
		label$109:;
		struct $7ASTNODE* vr$11 = ASTNEWBOP( OP$1, RELEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		RELEXPR$1 = vr$11;
...
struct $7ASTNODE* CISEXPRESSION( void )
{
	...
	label$118:;
	label$117:;
	if( (*(int64*)((uint8*)ISEXPR$1 + 8ll) & 511ll) != 18ll ) goto label$120;
	{
		if( (int64)-((*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)ISEXPR$1 + 16ll) + 16ll) & 4194304ll) != 0ll) != 0ll ) goto label$122;
		{
			ERRREPORT( 296ll, 0ll, (uint8*)0ull );
			struct $7ASTNODE* vr$13 = ASTNEWCONSTI( 0ll, 7ll, (struct $8FBSYMBOL*)0ull );
			ISEXPR$1 = vr$13;
		}
		label$122:;
	...
	TMP$92$1 = 0ll;
	int64 vr$18 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$92$1, 1ll );
	if( vr$18 != 0ll ) goto label$124;
	{
		fb$result$1 = (struct $7ASTNODE*)0ull;
		goto label$114;
	}
	label$124:;
	label$123:;
	if( (DTYPE$1 & 511ll) != 18ll ) goto label$126;
	{
		if( (int64)-((*(int64*)((uint8*)SUBTYPE$1 + 16ll) & 4194304ll) != 0ll) != 0ll ) goto label$128;
		{
			ERRREPORT( 296ll, 0ll, (uint8*)0ull );
		...
		goto label$127;
		label$128:;
		int64 vr$28 = SYMBGETUDTBASELEVEL( SUBTYPE$1, *(struct $8FBSYMBOL**)((uint8*)ISEXPR$1 + 16ll) );
		if( vr$28 != 0ll ) goto label$129;
		{
	...
	label$125:;
	struct $7ASTNODE* EXPR$1;
	struct $7ASTNODE* vr$34 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)SUBTYPE$1 + 224ll) + 296ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	EXPR$1 = vr$34;
	struct $7ASTNODE* vr$35 = ASTNEWBOP( 51ll, ISEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
	ISEXPR$1 = vr$35;
...
struct $7ASTNODE* CCATEXPRESSION( void )
{
	...
	label$136:;
	{
		...
		label$141:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$8 = CADDEXPRESSION(  );
		EXPR$1 = vr$8;
		...
		label$144:;
		label$143:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( 44ll, CATEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		CATEXPR$1 = vr$10;
		if( CATEXPR$1 != (struct $7ASTNODE*)0ull ) goto label$146;
		{
			ERRREPORT( 20ll, 0ll, (uint8*)0ull );
			struct $7ASTNODE* vr$12 = ASTNEWCONSTSTR( (uint8*)0ull );
			CATEXPR$1 = vr$12;
		}
		label$146:;
		label$145:;
	...
	{
		{
			...
			int64 vr$3 = LEXGETTOKEN( 0ll );
			TMP$93$3 = vr$3;
			if( TMP$93$3 != 43ll ) goto label$155;
			label$156:;
			{
				OP$1 = 28ll;
			}
			goto label$154;
			label$155:;
			if( TMP$93$3 != 45ll ) goto label$157;
			label$158:;
			{
				OP$1 = 29ll;
			}
		...
		label$160:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$9 = CSHIFTEXPRESSION(  );
		EXPR$1 = vr$9;
		...
		label$163:;
		label$162:;
		struct $7ASTNODE* vr$11 = ASTNEWBOP( OP$1, ADDEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 7ll );
		ADDEXPR$1 = vr$11;
	...
	{
		{
			...
			int64 vr$3 = LEXGETTOKEN( 0ll );
			TMP$94$3 = vr$3;
			if( TMP$94$3 != 297ll ) goto label$174;
			label$175:;
			{
				OP$1 = 41ll;
			}
			goto label$173;
			label$174:;
			if( TMP$94$3 != 298ll ) goto label$176;
			label$177:;
			{
				OP$1 = 42ll;
			}
		...
		label$179:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$9 = CMODEXPRESSION(  );
		EXPR$1 = vr$9;
		...
		label$182:;
		label$181:;
		struct $7ASTNODE* vr$11 = ASTNEWBOP( OP$1, SHIFTEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		SHIFTEXPR$1 = vr$11;
...
struct $7ASTNODE* CMODEXPRESSION( void )
{
	...
	label$189:;
	{
		...
		label$194:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$8 = CINTDIVEXPRESSION(  );
		EXPR$1 = vr$8;
		...
		label$197:;
		label$196:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( 33ll, MODEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		MODEXPR$1 = vr$10;
...
struct $7ASTNODE* CINTDIVEXPRESSION( void )
{
	...
	label$204:;
	{
		...
		label$209:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$8 = CMULTEXPRESSION(  );
		EXPR$1 = vr$8;
		...
		label$212:;
		label$211:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( 32ll, IDIVEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		IDIVEXPR$1 = vr$10;
	...
	{
		{
			...
			int64 vr$3 = LEXGETTOKEN( 0ll );
			TMP$95$3 = vr$3;
			if( TMP$95$3 != 42ll ) goto label$223;
			label$224:;
			{
				OP$1 = 30ll;
			}
			goto label$222;
			label$223:;
			if( TMP$95$3 != 47ll ) goto label$225;
			label$226:;
			{
				OP$1 = 31ll;
			}
		...
		label$228:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$9 = CEXPEXPRESSION(  );
		EXPR$1 = vr$9;
		...
		label$231:;
		label$230:;
		struct $7ASTNODE* vr$11 = ASTNEWBOP( OP$1, MULEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		MULEXPR$1 = vr$11;
...
struct $7ASTNODE* CEXPEXPRESSION( void )
{
	...
	label$238:;
	{
		...
		label$243:;
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$8 = CNEGNOTEXPRESSION(  );
		EXPR$1 = vr$8;
		...
		label$246:;
		label$245:;
		struct $7ASTNODE* vr$10 = ASTNEWBOP( 43ll, EXPEXPR$1, EXPR$1, (struct $8FBSYMBOL*)0ull, 1ll );
		EXPEXPR$1 = vr$10;
...
__attribute__(( constructor )) static void fb_ctor__parserzexprzbinary( void )
{
	label$0:;
	label$1:;
}
...
// Total compilation time: 0.04443992057349533 seconds.
