// Compilation of FreeBASIC-1.01.0-source/src/compiler/hlp.bas started at 16:30:10 on 02-28-2015
...
int64 HFILEEXISTS( uint8* FILENAME$1 )
{
	...
	if( (int64)vr$5 != 0ll ) goto label$61;
	{
		...
		void* vr$12 = fb_ErrorThrowAt( 191, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
		goto *vr$12;
		label$62:;
	}
	goto label$60;
	...
	if( (int64)vr$5 != 0ll ) goto label$152;
	{
		...
		label$153:;
		{
			...
			label$163:;
			{
				...
				void* vr$29 = fb_ErrorThrowAt( 455, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$29;
				label$164:;
			}
			goto label$161;
			...
			label$166:;
			{
				...
				void* vr$35 = fb_ErrorThrowAt( 458, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$35;
				label$167:;
			}
			goto label$161;
			...
			label$169:;
			{
				...
				void* vr$42 = fb_ErrorThrowAt( 462, (uint8*)"FreeBASIC-1.01.0-source/src/compiler/hlp.bas", (void*)0ull, (void*)0ull );
				goto *vr$42;
				label$171:;
			}
			label$168:;
...
// Total compilation time: 0.03214802325237542 seconds.
