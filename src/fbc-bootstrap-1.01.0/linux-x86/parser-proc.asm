	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-proc.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HSETUDTPROPERTYFLAGS, .-HSETUDTPROPERTYFLAGS
	#FreeBASIC-1.01.0-source/src/compiler/parser-proc.bas' compilation took 0.05313790682703257 secs
