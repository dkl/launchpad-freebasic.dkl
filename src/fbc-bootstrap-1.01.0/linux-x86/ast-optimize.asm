	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-optimize.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HOPTRECIPROCAL, .-HOPTRECIPROCAL
	#FreeBASIC-1.01.0-source/src/compiler/ast-optimize.bas' compilation took 0.0425950683420524 secs
