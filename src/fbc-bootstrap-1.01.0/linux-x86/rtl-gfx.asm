	...
	#FreeBASIC-1.01.0-source/src/compiler/rtl-gfx.bas' compilation started at 16:30:07 (FreeBASIC 1.01.0)
...
.size HGETPUTTER, .-HGETPUTTER
	#FreeBASIC-1.01.0-source/src/compiler/rtl-gfx.bas' compilation took 0.07041411008685827 secs
