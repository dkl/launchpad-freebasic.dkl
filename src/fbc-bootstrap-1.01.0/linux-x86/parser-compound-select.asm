	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-compound-select.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size HFLUSHCASEEXPR, .-HFLUSHCASEEXPR
	#FreeBASIC-1.01.0-source/src/compiler/parser-compound-select.bas' compilation took 0.0378699746215716 secs
