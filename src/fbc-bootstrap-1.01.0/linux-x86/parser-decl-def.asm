	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-decl-def.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/parser-decl-def.bas' compilation took 0.02687199215870351 secs
