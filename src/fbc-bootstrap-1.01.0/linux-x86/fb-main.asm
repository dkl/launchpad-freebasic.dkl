	...
	#FreeBASIC-1.01.0-source/src/compiler/fb-main.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size HMODLEVELBEGIN, .-HMODLEVELBEGIN
	#FreeBASIC-1.01.0-source/src/compiler/fb-main.bas' compilation took 0.02949993207585067 secs
