	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-expr-unary.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size HVARPTRBODY, .-HVARPTRBODY
	#FreeBASIC-1.01.0-source/src/compiler/parser-expr-unary.bas' compilation took 0.03930707543622702 secs
