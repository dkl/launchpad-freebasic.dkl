	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-mangling.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size HMANGLEPROC, .-HMANGLEPROC
	#FreeBASIC-1.01.0-source/src/compiler/symb-mangling.bas' compilation took 0.03508709941525012 secs
