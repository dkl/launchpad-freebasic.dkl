	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-identifier.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size HISSTRUCTALLOWED, .-HISSTRUCTALLOWED
	#FreeBASIC-1.01.0-source/src/compiler/parser-identifier.bas' compilation took 0.04048811784014106 secs
