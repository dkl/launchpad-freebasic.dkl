	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-mem.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HCALLDTORLIST, .-HCALLDTORLIST
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-mem.bas' compilation took 0.03233692434150726 secs
