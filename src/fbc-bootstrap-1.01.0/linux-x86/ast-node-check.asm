	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-check.bas' compilation started at 16:30:02 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-check.bas' compilation took 0.03311096329707652 secs
