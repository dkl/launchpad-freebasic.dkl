	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-compound-with.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size HEXTENDTEMPLIFETIME, .-HEXTENDTEMPLIFETIME
	#FreeBASIC-1.01.0-source/src/compiler/parser-compound-with.bas' compilation took 0.02992789796553552 secs
