	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-expr-binary.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/parser-expr-binary.bas' compilation took 0.04382004868239164 secs
