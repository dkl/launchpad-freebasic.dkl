	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-enum.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/symb-enum.bas' compilation took 0.0273110211128369 secs
