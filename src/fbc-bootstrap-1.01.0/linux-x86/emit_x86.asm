	...
	#FreeBASIC-1.01.0-source/src/compiler/emit_x86.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.balign 4
	.lcomm	Lt_0E3F,12
	#FreeBASIC-1.01.0-source/src/compiler/emit_x86.bas' compilation took 0.0832619050052017 secs
