	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-math.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HLENSIZEOF, .-HLENSIZEOF
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-math.bas' compilation took 0.03597797290422022 secs
