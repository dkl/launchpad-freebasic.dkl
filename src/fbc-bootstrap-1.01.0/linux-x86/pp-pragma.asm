	...
	#FreeBASIC-1.01.0-source/src/compiler/pp-pragma.bas' compilation started at 16:30:07 (FreeBASIC 1.01.0)
...
.size PRAGMAPOP, .-PRAGMAPOP
	#FreeBASIC-1.01.0-source/src/compiler/pp-pragma.bas' compilation took 0.02918605506420135 secs
