	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-statement.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/parser-statement.bas' compilation took 0.02905111387372017 secs
