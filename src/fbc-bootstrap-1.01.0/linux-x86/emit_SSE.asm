	...
	#FreeBASIC-1.01.0-source/src/compiler/emit_SSE.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.balign 4
	.lcomm	Lt_0AA1,4
	#FreeBASIC-1.01.0-source/src/compiler/emit_SSE.bas' compilation took 0.0688840999500826 secs
