	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-define.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size HDELDEFINETOKENS, .-HDELDEFINETOKENS
	#FreeBASIC-1.01.0-source/src/compiler/symb-define.bas' compilation took 0.03232694533653557 secs
