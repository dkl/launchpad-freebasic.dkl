	...
	#FreeBASIC-1.01.0-source/src/compiler/stack.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.balign 4
	.lcomm	Lt_002D,4
	#FreeBASIC-1.01.0-source/src/compiler/stack.bas' compilation took 0.001667956938035786 secs
