	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-struct.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size HFINDCOMMONPARENT, .-HFINDCOMMONPARENT
	#FreeBASIC-1.01.0-source/src/compiler/symb-struct.bas' compilation took 0.03479096700903028 secs
