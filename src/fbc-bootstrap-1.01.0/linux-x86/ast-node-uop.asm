	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-uop.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HCONSTUOP, .-HCONSTUOP
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-uop.bas' compilation took 0.03324007394257933 secs
