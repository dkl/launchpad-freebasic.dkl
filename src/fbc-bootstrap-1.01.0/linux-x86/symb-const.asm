	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-const.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/symb-const.bas' compilation took 0.02492688247002661 secs
