	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-array.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HSCOPEDSWAP, .-HSCOPEDSWAP
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-array.bas' compilation took 0.03664604772347957 secs
