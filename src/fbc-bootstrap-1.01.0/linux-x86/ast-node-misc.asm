	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-misc.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size ASTDUMPTREEEX, .-ASTDUMPTREEEX
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-misc.bas' compilation took 0.03859002678655088 secs
