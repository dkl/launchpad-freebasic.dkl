	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-addr.bas' compilation started at 16:30:02 (FreeBASIC 1.01.0)
...
.size HREMOVENULLPTRCHECK, .-HREMOVENULLPTRCHECK
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-addr.bas' compilation took 0.02902193006593734 secs
