	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-vectorize.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HCHECKLINK, .-HCHECKLINK
	#FreeBASIC-1.01.0-source/src/compiler/ast-vectorize.bas' compilation took 0.02746998285874724 secs
