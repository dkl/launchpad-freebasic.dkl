	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-conv.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HCHECKPTR, .-HCHECKPTR
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-conv.bas' compilation took 0.03596008254680783 secs
