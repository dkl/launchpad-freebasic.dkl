	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-goto-return.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HGOSUBRETURN, .-HGOSUBRETURN
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-goto-return.bas' compilation took 0.0338360492605716 secs
