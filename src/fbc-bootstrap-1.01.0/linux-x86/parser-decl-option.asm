	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-decl-option.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size HUNDEFSYMBOL, .-HUNDEFSYMBOL
	#FreeBASIC-1.01.0-source/src/compiler/parser-decl-option.bas' compilation took 0.02898991957772523 secs
