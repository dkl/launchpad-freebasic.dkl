	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-mem.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-mem.bas' compilation took 0.02929503447376192 secs
