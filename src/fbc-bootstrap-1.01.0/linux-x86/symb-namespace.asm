	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-namespace.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size HISONIMPORTLIST, .-HISONIMPORTLIST
	#FreeBASIC-1.01.0-source/src/compiler/symb-namespace.bas' compilation took 0.02967503434047103 secs
