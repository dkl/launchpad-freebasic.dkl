	...
	#FreeBASIC-1.01.0-source/src/compiler/ir-llvm.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size _GLOBAL__D, .-_GLOBAL__D
	#FreeBASIC-1.01.0-source/src/compiler/ir-llvm.bas' compilation took 0.05028096085879952 secs
