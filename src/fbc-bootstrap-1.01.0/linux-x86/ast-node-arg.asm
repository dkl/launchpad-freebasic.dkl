	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-arg.bas' compilation started at 16:30:02 (FreeBASIC 1.01.0)
...
.size HCREATEOPTARG, .-HCREATEOPTARG
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-arg.bas' compilation took 0.038111966336146 secs
