	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-expr-variable.bas' compilation started at 16:30:05 (FreeBASIC 1.01.0)
...
.size HIMPFIELD, .-HIMPFIELD
	#FreeBASIC-1.01.0-source/src/compiler/parser-expr-variable.bas' compilation took 0.0521040913881734 secs
