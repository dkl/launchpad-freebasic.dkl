	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-assignment.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size HASSIGNFROMFIELD, .-HASSIGNFROMFIELD
	#FreeBASIC-1.01.0-source/src/compiler/parser-assignment.bas' compilation took 0.03181406005751342 secs
