	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-proc.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HGENGLOBALINSTANCESCTOR, .-HGENGLOBALINSTANCESCTOR
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-proc.bas' compilation took 0.0427310043014586 secs
