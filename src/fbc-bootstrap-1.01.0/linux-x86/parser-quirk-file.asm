	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-file.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HFILERENAME, .-HFILERENAME
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-file.bas' compilation took 0.04299004597123712 secs
