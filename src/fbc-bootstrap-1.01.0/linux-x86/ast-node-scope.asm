	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-scope.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HCHECKBRANCH, .-HCHECKBRANCH
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-scope.bas' compilation took 0.03162388550117612 secs
