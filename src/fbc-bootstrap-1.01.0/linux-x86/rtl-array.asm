	...
	#FreeBASIC-1.01.0-source/src/compiler/rtl-array.bas' compilation started at 16:30:07 (FreeBASIC 1.01.0)
...
.size HGETCTORDTORFORREDIM, .-HGETCTORDTORFORREDIM
	#FreeBASIC-1.01.0-source/src/compiler/rtl-array.bas' compilation took 0.03748103056568652 secs
