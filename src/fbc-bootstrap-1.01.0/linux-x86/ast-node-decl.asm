	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-decl.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HDEFAULTINIT, .-HDEFAULTINIT
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-decl.bas' compilation took 0.02406796813011169 secs
