	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-string.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size CSTRASC, .-CSTRASC
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-string.bas' compilation took 0.04534706263802946 secs
