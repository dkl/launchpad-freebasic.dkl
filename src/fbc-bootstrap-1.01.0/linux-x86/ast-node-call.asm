	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-call.bas' compilation started at 16:30:02 (FreeBASIC 1.01.0)
...
.size HCOPYSTRINGSBACK, .-HCOPYSTRINGSBACK
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-call.bas' compilation took 0.03278909856453538 secs
