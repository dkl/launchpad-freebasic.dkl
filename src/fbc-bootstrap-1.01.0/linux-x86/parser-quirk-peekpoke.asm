	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-peekpoke.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HOPTIONALTYPEANDFIRSTEXPR, .-HOPTIONALTYPEANDFIRSTEXPR
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-peekpoke.bas' compilation took 0.02858690079301596 secs
