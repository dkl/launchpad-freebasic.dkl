	...
	#FreeBASIC-1.01.0-source/src/compiler/rtl-error.bas' compilation started at 16:30:07 (FreeBASIC 1.01.0)
...
.size HERRORTHROW, .-HERRORTHROW
	#FreeBASIC-1.01.0-source/src/compiler/rtl-error.bas' compilation took 0.04061807226389647 secs
