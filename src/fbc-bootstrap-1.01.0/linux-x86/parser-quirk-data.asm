	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-data.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk-data.bas' compilation took 0.03636491973884404 secs
