	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-ptr.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-ptr.bas' compilation took 0.02390400774311274 secs
