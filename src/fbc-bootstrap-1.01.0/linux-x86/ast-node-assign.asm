	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-assign.bas' compilation started at 16:30:02 (FreeBASIC 1.01.0)
...
.size HSHALLOWCOPY, .-HSHALLOWCOPY
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-assign.bas' compilation took 0.03692791354842484 secs
