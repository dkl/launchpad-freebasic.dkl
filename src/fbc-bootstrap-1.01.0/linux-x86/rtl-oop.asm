	...
	#FreeBASIC-1.01.0-source/src/compiler/rtl-oop.bas' compilation started at 16:30:07 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/rtl-oop.bas' compilation took 0.03564694838132709 secs
