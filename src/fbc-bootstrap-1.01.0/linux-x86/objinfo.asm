	...
	#FreeBASIC-1.01.0-source/src/compiler/objinfo.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size _GLOBAL__D, .-_GLOBAL__D
	#FreeBASIC-1.01.0-source/src/compiler/objinfo.bas' compilation took 0.0116799728712067 secs
...
.balign 4
Lt_00E0:	.ascii	"FreeBASIC-1.01.0-source/src/compiler/objinfo.bas\0"
