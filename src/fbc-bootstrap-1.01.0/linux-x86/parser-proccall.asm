	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-proccall.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HBASEMEMBERACCESS, .-HBASEMEMBERACCESS
	#FreeBASIC-1.01.0-source/src/compiler/parser-proccall.bas' compilation took 0.04325795464683324 secs
