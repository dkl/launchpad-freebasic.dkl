	...
	#FreeBASIC-1.01.0-source/src/compiler/symb.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size HFOREACHGLOBAL, .-HFOREACHGLOBAL
	#FreeBASIC-1.01.0-source/src/compiler/symb.bas' compilation took 0.04632907395716757 secs
