	...
	#FreeBASIC-1.01.0-source/src/compiler/error.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.balign 4
	.lcomm	Lt_02AC,12
	#FreeBASIC-1.01.0-source/src/compiler/error.bas' compilation took 0.03334509418345988 secs
