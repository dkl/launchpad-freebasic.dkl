	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-data.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/symb-data.bas' compilation took 0.02746205485891551 secs
