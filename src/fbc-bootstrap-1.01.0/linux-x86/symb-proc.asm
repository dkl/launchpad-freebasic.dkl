	...
	#FreeBASIC-1.01.0-source/src/compiler/symb-proc.bas' compilation started at 16:30:08 (FreeBASIC 1.01.0)
...
.size HRESULTTOSTR, .-HRESULTTOSTR
	#FreeBASIC-1.01.0-source/src/compiler/symb-proc.bas' compilation took 0.05527299095410854 secs
