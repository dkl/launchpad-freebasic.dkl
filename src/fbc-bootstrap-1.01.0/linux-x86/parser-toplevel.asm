	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-toplevel.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size HEMITCURRENTLINETEXT, .-HEMITCURRENTLINETEXT
	#FreeBASIC-1.01.0-source/src/compiler/parser-toplevel.bas' compilation took 0.03098297619726509 secs
