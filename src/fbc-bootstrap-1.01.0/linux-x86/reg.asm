	...
	#FreeBASIC-1.01.0-source/src/compiler/reg.bas' compilation started at 16:30:07 (FreeBASIC 1.01.0)
...
.size SREGINITCLASS, .-SREGINITCLASS
	#FreeBASIC-1.01.0-source/src/compiler/reg.bas' compilation took 0.03199407563079149 secs
