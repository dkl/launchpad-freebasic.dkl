	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-compound.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size CCOMPOUNDEND, .-CCOMPOUNDEND
	#FreeBASIC-1.01.0-source/src/compiler/parser-compound.bas' compilation took 0.03960993839427829 secs
