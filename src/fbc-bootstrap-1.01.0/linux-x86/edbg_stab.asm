	...
	#FreeBASIC-1.01.0-source/src/compiler/edbg_stab.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size HDECLENUM, .-HDECLENUM
	#FreeBASIC-1.01.0-source/src/compiler/edbg_stab.bas' compilation took 0.03742308844812214 secs
