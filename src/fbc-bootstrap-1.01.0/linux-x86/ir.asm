	...
	#FreeBASIC-1.01.0-source/src/compiler/ir.bas' compilation started at 16:30:04 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/ir.bas' compilation took 0.02820192137733102 secs
