	...
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/parser-quirk.bas' compilation took 0.03133202926255763 secs
