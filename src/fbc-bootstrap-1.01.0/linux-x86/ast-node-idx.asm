	...
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-idx.bas' compilation started at 16:30:03 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#FreeBASIC-1.01.0-source/src/compiler/ast-node-idx.bas' compilation took 0.02456388180144131 secs
