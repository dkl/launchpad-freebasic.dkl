	...
	#FreeBASIC-1.01.0-source/src/compiler/pp-cond.bas' compilation started at 16:30:06 (FreeBASIC 1.01.0)
...
ret
.size PPSKIP, .-PPSKIP
	#FreeBASIC-1.01.0-source/src/compiler/pp-cond.bas' compilation took 0.02775589108932763 secs
