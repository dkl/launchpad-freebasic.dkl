	...
	#fbc-1.01.0/src/compiler/ast-node-typeini.bas' compilation started at 14:16:34 (FreeBASIC 1.01.0)
...
ret
.size HWALK, .-HWALK
	#fbc-1.01.0/src/compiler/ast-node-typeini.bas' compilation took 0.03708591382019222 secs
