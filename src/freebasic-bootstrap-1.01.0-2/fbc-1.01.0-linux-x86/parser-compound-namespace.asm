	...
	#fbc-1.01.0/src/compiler/parser-compound-namespace.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size NAMESPACEBEGIN, .-NAMESPACEBEGIN
	#fbc-1.01.0/src/compiler/parser-compound-namespace.bas' compilation took 0.02675810095388442 secs
