	...
	#fbc-1.01.0/src/compiler/pp-cond.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
ret
.size PPSKIP, .-PPSKIP
	#fbc-1.01.0/src/compiler/pp-cond.bas' compilation took 0.0267859393497929 secs
