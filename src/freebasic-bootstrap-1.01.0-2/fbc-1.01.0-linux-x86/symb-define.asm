	...
	#fbc-1.01.0/src/compiler/symb-define.bas' compilation started at 14:16:39 (FreeBASIC 1.01.0)
...
.size HDELDEFINETOKENS, .-HDELDEFINETOKENS
	#fbc-1.01.0/src/compiler/symb-define.bas' compilation took 0.04526302148588002 secs
