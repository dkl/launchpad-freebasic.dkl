	...
	#fbc-1.01.0/src/compiler/ast-node-conv.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HCHECKPTR, .-HCHECKPTR
	#fbc-1.01.0/src/compiler/ast-node-conv.bas' compilation took 0.03496393840759993 secs
