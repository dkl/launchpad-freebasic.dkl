	...
	#fbc-1.01.0/src/compiler/hash.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size HASHDELITEM, .-HASHDELITEM
	#fbc-1.01.0/src/compiler/hash.bas' compilation took 0.004136987961828709 secs
