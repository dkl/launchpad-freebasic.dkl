	...
	#fbc-1.01.0/src/compiler/symb-comp.bas' compilation started at 14:16:38 (FreeBASIC 1.01.0)
...
.size HREMOVEIMPORTED, .-HREMOVEIMPORTED
	#fbc-1.01.0/src/compiler/symb-comp.bas' compilation took 0.03954506467562169 secs
