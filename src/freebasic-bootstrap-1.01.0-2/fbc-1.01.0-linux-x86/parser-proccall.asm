	...
	#fbc-1.01.0/src/compiler/parser-proccall.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
.size HBASEMEMBERACCESS, .-HBASEMEMBERACCESS
	#fbc-1.01.0/src/compiler/parser-proccall.bas' compilation took 0.04143098345957696 secs
