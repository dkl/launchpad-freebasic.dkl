	...
	#fbc-1.01.0/src/compiler/parser-assignment.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size HASSIGNFROMFIELD, .-HASSIGNFROMFIELD
	#fbc-1.01.0/src/compiler/parser-assignment.bas' compilation took 0.02996103628538549 secs
