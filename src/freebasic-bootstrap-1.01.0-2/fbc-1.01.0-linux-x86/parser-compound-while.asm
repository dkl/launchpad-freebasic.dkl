	...
	#fbc-1.01.0/src/compiler/parser-compound-while.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-compound-while.bas' compilation took 0.02527309639845043 secs
