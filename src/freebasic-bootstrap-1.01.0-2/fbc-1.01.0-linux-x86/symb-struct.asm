	...
	#fbc-1.01.0/src/compiler/symb-struct.bas' compilation started at 14:16:39 (FreeBASIC 1.01.0)
...
.size HFINDCOMMONPARENT, .-HFINDCOMMONPARENT
	#fbc-1.01.0/src/compiler/symb-struct.bas' compilation took 0.03340796020347625 secs
