	...
	#fbc-1.01.0/src/compiler/ast-node-assign.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HSHALLOWCOPY, .-HSHALLOWCOPY
	#fbc-1.01.0/src/compiler/ast-node-assign.bas' compilation took 0.03606891504023224 secs
