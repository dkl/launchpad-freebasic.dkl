	...
	#fbc-1.01.0/src/compiler/parser-compound.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size CCOMPOUNDEND, .-CCOMPOUNDEND
	#fbc-1.01.0/src/compiler/parser-compound.bas' compilation took 0.03757407295051962 secs
