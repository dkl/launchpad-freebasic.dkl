	...
	#fbc-1.01.0/src/compiler/parser-compound-select.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size HFLUSHCASEEXPR, .-HFLUSHCASEEXPR
	#fbc-1.01.0/src/compiler/parser-compound-select.bas' compilation took 0.03394089837092906 secs
