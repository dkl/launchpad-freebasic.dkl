	...
	#fbc-1.01.0/src/compiler/parser-quirk-math.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
.size HLENSIZEOF, .-HLENSIZEOF
	#fbc-1.01.0/src/compiler/parser-quirk-math.bas' compilation took 0.03288688277825713 secs
