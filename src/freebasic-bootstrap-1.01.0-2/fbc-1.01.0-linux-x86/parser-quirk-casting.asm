	...
	#fbc-1.01.0/src/compiler/parser-quirk-casting.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-quirk-casting.bas' compilation took 0.02685903257224709 secs
