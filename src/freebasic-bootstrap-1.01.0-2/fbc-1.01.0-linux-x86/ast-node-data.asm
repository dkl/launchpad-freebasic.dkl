	...
	#fbc-1.01.0/src/compiler/ast-node-data.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.int 0
.int 0
	#fbc-1.01.0/src/compiler/ast-node-data.bas' compilation took 0.02500593394506723 secs
