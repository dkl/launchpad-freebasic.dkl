	...
	#fbc-1.01.0/src/compiler/ast-node-addr.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HREMOVENULLPTRCHECK, .-HREMOVENULLPTRCHECK
	#fbc-1.01.0/src/compiler/ast-node-addr.bas' compilation took 0.02665402786806226 secs
