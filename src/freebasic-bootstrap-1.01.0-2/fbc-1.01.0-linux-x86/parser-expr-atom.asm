	...
	#fbc-1.01.0/src/compiler/parser-expr-atom.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size HCHECKID, .-HCHECKID
	#fbc-1.01.0/src/compiler/parser-expr-atom.bas' compilation took 0.02880293957423419 secs
