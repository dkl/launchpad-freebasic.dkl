	...
	#fbc-1.01.0/src/compiler/parser-decl-symbtype.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size CSYMBOLTYPEFUNCPTR, .-CSYMBOLTYPEFUNCPTR
	#fbc-1.01.0/src/compiler/parser-decl-symbtype.bas' compilation took 0.03548702294938266 secs
