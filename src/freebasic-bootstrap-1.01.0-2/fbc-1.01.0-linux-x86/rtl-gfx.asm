	...
	#fbc-1.01.0/src/compiler/rtl-gfx.bas' compilation started at 14:16:38 (FreeBASIC 1.01.0)
...
.size HGETPUTTER, .-HGETPUTTER
	#fbc-1.01.0/src/compiler/rtl-gfx.bas' compilation took 0.04432500852271914 secs
