	...
	#fbc-1.01.0/src/compiler/parser-decl-enum.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size HENUMCONSTDECL, .-HENUMCONSTDECL
	#fbc-1.01.0/src/compiler/parser-decl-enum.bas' compilation took 0.02633694431278855 secs
