	...
	#fbc-1.01.0/src/compiler/ast-node-uop.bas' compilation started at 14:16:34 (FreeBASIC 1.01.0)
...
.size HCONSTUOP, .-HCONSTUOP
	#fbc-1.01.0/src/compiler/ast-node-uop.bas' compilation took 0.03293110674712807 secs
