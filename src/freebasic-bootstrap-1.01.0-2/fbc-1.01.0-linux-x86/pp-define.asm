	...
	#fbc-1.01.0/src/compiler/pp-define.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
.size HMATCHPARAMELLIPSIS, .-HMATCHPARAMELLIPSIS
	#fbc-1.01.0/src/compiler/pp-define.bas' compilation took 0.03314805682748556 secs
