	...
	#fbc-1.01.0/src/compiler/parser-compound-with.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size HEXTENDTEMPLIFETIME, .-HEXTENDTEMPLIFETIME
	#fbc-1.01.0/src/compiler/parser-compound-with.bas' compilation took 0.02639194007497281 secs
