	...
	#fbc-1.01.0/src/compiler/ast-helper.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HCONSTBOUND, .-HCONSTBOUND
	#fbc-1.01.0/src/compiler/ast-helper.bas' compilation took 0.03961908002384007 secs
