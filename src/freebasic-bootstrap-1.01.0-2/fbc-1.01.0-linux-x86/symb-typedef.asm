	...
	#fbc-1.01.0/src/compiler/symb-typedef.bas' compilation started at 14:16:39 (FreeBASIC 1.01.0)
...
.size HFIXFORWARDREF, .-HFIXFORWARDREF
	#fbc-1.01.0/src/compiler/symb-typedef.bas' compilation took 0.02660399617161602 secs
