	...
	#fbc-1.01.0/src/compiler/reg.bas' compilation started at 14:16:38 (FreeBASIC 1.01.0)
...
.size SREGINITCLASS, .-SREGINITCLASS
	#fbc-1.01.0/src/compiler/reg.bas' compilation took 0.02572295267600566 secs
