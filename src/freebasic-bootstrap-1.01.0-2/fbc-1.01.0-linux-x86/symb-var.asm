	...
	#fbc-1.01.0/src/compiler/symb-var.bas' compilation started at 14:16:39 (FreeBASIC 1.01.0)
...
.size SYMBRECALCARRAYDIFFANDELEMENTS, .-SYMBRECALCARRAYDIFFANDELEMENTS
	#fbc-1.01.0/src/compiler/symb-var.bas' compilation took 0.03481007611844689 secs
