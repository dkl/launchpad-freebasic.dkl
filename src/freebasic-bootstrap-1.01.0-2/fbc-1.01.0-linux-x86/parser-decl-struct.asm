	...
	#fbc-1.01.0/src/compiler/parser-decl-struct.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size HPATCHBYVALRESULTTOSELF, .-HPATCHBYVALRESULTTOSELF
	#fbc-1.01.0/src/compiler/parser-decl-struct.bas' compilation took 0.03181810211390257 secs
