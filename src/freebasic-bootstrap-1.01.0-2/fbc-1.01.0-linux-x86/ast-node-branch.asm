	...
	#fbc-1.01.0/src/compiler/ast-node-branch.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size ASTNEWJMPTB, .-ASTNEWJMPTB
	#fbc-1.01.0/src/compiler/ast-node-branch.bas' compilation took 0.02760211727581918 secs
