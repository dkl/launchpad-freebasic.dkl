	...
	#fbc-1.01.0/src/compiler/lex.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size LEXGETSTRLITTEXT, .-LEXGETSTRLITTEXT
	#fbc-1.01.0/src/compiler/lex.bas' compilation took 0.06006105686537921 secs
