	...
	#fbc-1.01.0/src/compiler/rtl-array.bas' compilation started at 14:16:38 (FreeBASIC 1.01.0)
...
.size HGETCTORDTORFORREDIM, .-HGETCTORDTORFORREDIM
	#fbc-1.01.0/src/compiler/rtl-array.bas' compilation took 0.03412700176704675 secs
