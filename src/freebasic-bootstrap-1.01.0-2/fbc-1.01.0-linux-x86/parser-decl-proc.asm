	...
	#fbc-1.01.0/src/compiler/parser-decl-proc.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-decl-proc.bas' compilation took 0.02427194477058947 secs
