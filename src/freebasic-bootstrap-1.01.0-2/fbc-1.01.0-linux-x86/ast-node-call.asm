	...
	#fbc-1.01.0/src/compiler/ast-node-call.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HCOPYSTRINGSBACK, .-HCOPYSTRINGSBACK
	#fbc-1.01.0/src/compiler/ast-node-call.bas' compilation took 0.03274292673449963 secs
