	...
	#fbc-1.01.0/src/compiler/ast-node-bop.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HCONVOPERAND, .-HCONVOPERAND
	#fbc-1.01.0/src/compiler/ast-node-bop.bas' compilation took 0.04950691992416978 secs
