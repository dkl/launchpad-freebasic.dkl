	...
	#fbc-1.01.0/src/compiler/parser-decl-proc-params.bas' compilation started at 14:16:36 (FreeBASIC 1.01.0)
...
.int 0
.int 1
	#fbc-1.01.0/src/compiler/parser-decl-proc-params.bas' compilation took 0.02761888387612998 secs
