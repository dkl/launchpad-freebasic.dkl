	...
	#fbc-1.01.0/src/compiler/hlp.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size STRISQUOTED, .-STRISQUOTED
	#fbc-1.01.0/src/compiler/hlp.bas' compilation took 0.02836603741161525 secs
