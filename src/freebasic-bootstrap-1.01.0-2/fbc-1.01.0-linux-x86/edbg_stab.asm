	...
	#fbc-1.01.0/src/compiler/edbg_stab.bas' compilation started at 14:16:34 (FreeBASIC 1.01.0)
...
.size HDECLENUM, .-HDECLENUM
	#fbc-1.01.0/src/compiler/edbg_stab.bas' compilation took 0.03905994514934719 secs
