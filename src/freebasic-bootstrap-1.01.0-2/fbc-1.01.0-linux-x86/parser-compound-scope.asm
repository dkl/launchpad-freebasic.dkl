	...
	#fbc-1.01.0/src/compiler/parser-compound-scope.bas' compilation started at 14:16:35 (FreeBASIC 1.01.0)
...
.size _ZN11TSTRSETITEMaSERKS_, .-_ZN11TSTRSETITEMaSERKS_
	#fbc-1.01.0/src/compiler/parser-compound-scope.bas' compilation took 0.02544207475148141 secs
