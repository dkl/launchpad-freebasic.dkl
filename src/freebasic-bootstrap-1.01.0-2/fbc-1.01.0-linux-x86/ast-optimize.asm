	...
	#fbc-1.01.0/src/compiler/ast-optimize.bas' compilation started at 14:16:34 (FreeBASIC 1.01.0)
...
.size HOPTRECIPROCAL, .-HOPTRECIPROCAL
	#fbc-1.01.0/src/compiler/ast-optimize.bas' compilation took 0.04500710696447641 secs
