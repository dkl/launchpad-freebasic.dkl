	...
	#fbc-1.01.0/src/compiler/parser-proccall-args.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
.size HOVLPROCARGLIST, .-HOVLPROCARGLIST
	#fbc-1.01.0/src/compiler/parser-proccall-args.bas' compilation took 0.03015197662170976 secs
