	...
	#fbc-1.01.0/src/compiler/rtl-string.bas' compilation started at 14:16:38 (FreeBASIC 1.01.0)
...
.size HEVALASCCASE, .-HEVALASCCASE
	#fbc-1.01.0/src/compiler/rtl-string.bas' compilation took 0.05483388272114098 secs
