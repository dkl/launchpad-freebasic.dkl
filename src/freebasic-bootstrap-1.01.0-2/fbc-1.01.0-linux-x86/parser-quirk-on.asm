	...
	#fbc-1.01.0/src/compiler/parser-quirk-on.bas' compilation started at 14:16:37 (FreeBASIC 1.01.0)
...
.size CGOTBSTMT, .-CGOTBSTMT
	#fbc-1.01.0/src/compiler/parser-quirk-on.bas' compilation took 0.03197999391704798 secs
