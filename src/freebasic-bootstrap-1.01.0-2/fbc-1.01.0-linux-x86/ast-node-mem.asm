	...
	#fbc-1.01.0/src/compiler/ast-node-mem.bas' compilation started at 14:16:34 (FreeBASIC 1.01.0)
...
.size HCALLDTORLIST, .-HCALLDTORLIST
	#fbc-1.01.0/src/compiler/ast-node-mem.bas' compilation took 0.03712198499124497 secs
