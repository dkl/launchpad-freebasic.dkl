	...
	#fbc-1.01.0/src/compiler/rtl-macro.bas' compilation started at 14:16:38 (FreeBASIC 1.01.0)
...
.size HADDMACROS, .-HADDMACROS
	#fbc-1.01.0/src/compiler/rtl-macro.bas' compilation took 0.03303402836900204 secs
