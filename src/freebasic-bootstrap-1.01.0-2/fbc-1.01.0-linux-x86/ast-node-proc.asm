	...
	#fbc-1.01.0/src/compiler/ast-node-proc.bas' compilation started at 14:16:34 (FreeBASIC 1.01.0)
...
.size HGENGLOBALINSTANCESCTOR, .-HGENGLOBALINSTANCESCTOR
	#fbc-1.01.0/src/compiler/ast-node-proc.bas' compilation took 0.0455719392048195 secs
