	...
	#fbc-1.01.0/src/compiler/ast-misc.bas' compilation started at 14:16:33 (FreeBASIC 1.01.0)
...
.size HSYMBISONLOCALSTACK, .-HSYMBISONLOCALSTACK
	#fbc-1.01.0/src/compiler/ast-misc.bas' compilation took 0.04127402219455689 secs
