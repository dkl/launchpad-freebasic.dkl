// Compilation of fbc-1.01.0/src/compiler/list.bas started at 14:16:41 on 02-28-2015
...
static void FATALOUTOFMEMORY( void )
{
	label$2:;
	label$4:;
	void* vr$0 = fb_ErrorThrowEx( 4, 10, (uint8*)"fbc-1.01.0/src/compiler/list.bas", (void*)0ull, (void*)0ull );
	goto *vr$0;
	label$5:;
	label$3:;
}

// Total compilation time: 0.003561943070963025 seconds.
